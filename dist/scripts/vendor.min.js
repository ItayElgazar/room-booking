 ...
 * v0.9.0
 */
!function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,r,a,l,c,i,s,m){function d(n,o,m){o=r.extractElementByName(o,"md-bottom-sheet"),f=l('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n),f.on("click",function(){a(i.cancel)}),c.inherit(f,m.parent),e.enter(f,m.parent,null);var d=new p(o,m.parent);return m.bottomSheet=d,m.targetEvent&&angular.element(m.targetEvent.target).blur(),c.inherit(d.element,m.parent),m.disableParentScroll&&(m.lastOverflow=m.parent.css("overflow"),m.parent.css("overflow","hidden")),e.enter(d.element,m.parent).then(function(){var e=angular.element(o[0].querySelector("button")||o[0].querySelector("a")||o[0].querySelector("[ng-click]"));e.focus(),m.escapeToClose&&(m.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&a(i.cancel)},s.on("keyup",m.rootElementKeyupCallback))})}function u(t,n,o){var r=o.bottomSheet;return e.leave(f),e.leave(r.element).then(function(){o.disableParentScroll&&(o.parent.css("overflow",o.lastOverflow),delete o.lastOverflow),r.cleanup(),o.targetEvent&&angular.element(o.targetEvent.target).focus()})}function p(e,r){function l(n){e.css(t.CSS.TRANSITION_DURATION,"0ms")}function c(n){var r=n.pointer.distanceY;5>r&&(r=Math.max(-o,r/2)),e.css(t.CSS.TRANSFORM,"translate3d(0,"+(o+r)+"px,0)")}function s(o){if(o.pointer.distanceY>0&&(o.pointer.distanceY>20||Math.abs(o.pointer.velocityY)>n)){var r=e.prop("offsetHeight")-o.pointer.distanceY,l=Math.min(r/o.pointer.velocityY*.75,500);e.css(t.CSS.TRANSITION_DURATION,l+"ms"),a(i.cancel)}else e.css(t.CSS.TRANSITION_DURATION,""),e.css(t.CSS.TRANSFORM,"")}var d=m.register(r,"drag",{horizontal:!1});return r.on("$md.dragstart",l).on("$md.drag",c).on("$md.dragend",s),{element:e,cleanup:function(){d(),r.off("$md.dragstart",l).off("$md.drag",c).off("$md.dragend",s)}}}var f;return{themable:!0,targetEvent:null,onShow:d,onRemove:u,escapeToClose:!0,disableParentScroll:!0}}var n=.5,o=80;return t.$inject=["$animate","$mdConstant","$mdUtil","$timeout","$compile","$mdTheming","$mdBottomSheet","$rootElement","$mdGesture"],e("$mdBottomSheet").setDefaults({methods:["disableParentScroll","escapeToClose","targetEvent"],options:t})}angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",e).provider("$mdBottomSheet",t),t.$inject=["$$interimElementProvider"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function n(n,t,e,i){function a(n){return angular.isDefined(n.href)||angular.isDefined(n.ngHref)||angular.isDefined(n.ngLink)||angular.isDefined(n.uiSref)}function u(n,t){return a(t)?'<a class="md-button" ng-transclude></a>':'<button class="md-button" ng-transclude></button>'}function o(u,o,r){var c=o[0];t(o),n.attachButtonBehavior(u,o);var s=c.textContent.trim();s||e.expect(o,"aria-label"),a(r)&&angular.isDefined(r.ngDisabled)&&u.$watch(r.ngDisabled,function(n){o.attr("tabindex",n?-1:0)}),o.on("click",function(n){r.disabled===!0&&(n.preventDefault(),n.stopImmediatePropagation())}),u.mouseActive=!1,o.on("mousedown",function(){u.mouseActive=!0,i(function(){u.mouseActive=!1},100)}).on("focus",function(){u.mouseActive===!1&&o.addClass("md-focused")}).on("blur",function(){o.removeClass("md-focused")})}return{restrict:"EA",replace:!0,transclude:!0,template:u,link:o}}angular.module("material.components.button",["material.core"]).directive("mdButton",n),n.$inject=["$mdInkRipple","$mdTheming","$mdAria","$timeout"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function n(n){return{restrict:"E",link:function(t,e,i){n(e)}}}angular.module("material.components.card",["material.core"]).directive("mdCard",n),n.$inject=["$mdTheming"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e,n,i,t,c,d,a){function o(n,o){return o.type="checkbox",o.tabindex=o.tabindex||"0",n.attr("role",o.type),function(n,o,r,u){function l(e,i,t){r[e]&&n.$watch(r[e],function(e){t[e]&&o.attr(i,t[e])})}function m(e){var n=e.which||e.keyCode;(n===t.KEY_CODE.SPACE||n===t.KEY_CODE.ENTER)&&(e.preventDefault(),o.hasClass("md-focused")||o.addClass("md-focused"),f(e))}function f(e){o[0].hasAttribute("disabled")||n.$apply(function(){var n=r.ngChecked?r.checked:!u.$viewValue;u.$setViewValue(n,e&&e.type),u.$render()})}function p(){u.$viewValue?o.addClass(s):o.removeClass(s)}u=u||d.fakeNgModel(),c(o),r.ngChecked&&n.$watch(n.$eval.bind(n,r.ngChecked),u.$setViewValue.bind(u)),l("ngDisabled","tabindex",{"true":"-1","false":r.tabindex}),i.expectWithText(o,"aria-label"),e.link.pre(n,{on:angular.noop,0:{}},r,[u]),n.mouseActive=!1,o.on("click",f).on("keypress",m).on("mousedown",function(){n.mouseActive=!0,a(function(){n.mouseActive=!1},100)}).on("focus",function(){n.mouseActive===!1&&o.addClass("md-focused")}).on("blur",function(){o.removeClass("md-focused")}),u.$render=p}}e=e[0];var s="md-checked";return{restrict:"E",transclude:!0,require:"?ngModel",priority:210,template:'<div class="md-container" md-ink-ripple md-ink-ripple-checkbox><div class="md-icon"></div></div><div ng-transclude class="md-label"></div>',compile:o}}angular.module("material.components.checkbox",["material.core"]).directive("mdCheckbox",e),e.$inject=["inputDirective","$mdInkRipple","$mdAria","$mdConstant","$mdTheming","$mdUtil","$timeout"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 * v0.9.0
 */
!function(){"use strict";!function(){function e(e,n){e.decorator("$$rAF",["$delegate",t]),n.theme("default").primaryPalette("indigo").accentPalette("pink").warnPalette("red").backgroundPalette("grey")}function t(e){return e.throttle=function(t){var n,r,o,a;return function(){n=arguments,a=this,o=t,r||(r=!0,e(function(){o.apply(a,n),r=!1}))}},e}angular.module("material.core",["material.core.gestures","material.core.theming"]).config(e),e.$inject=["$provide","$mdThemingProvider"]}(),function(){function e(e,t){function n(e){return r?"webkit"+e.charAt(0).toUpperCase()+e.substring(1):e}var r=/webkit/i.test(t.vendorPrefix);return{KEY_CODE:{ENTER:13,ESCAPE:27,SPACE:32,LEFT_ARROW:37,UP_ARROW:38,RIGHT_ARROW:39,DOWN_ARROW:40,TAB:9,BACKSPACE:8,DELETE:46},CSS:{TRANSITIONEND:"transitionend"+(r?" webkitTransitionEnd":""),ANIMATIONEND:"animationend"+(r?" webkitAnimationEnd":""),TRANSFORM:n("transform"),TRANSFORM_ORIGIN:n("transformOrigin"),TRANSITION:n("transition"),TRANSITION_DURATION:n("transitionDuration"),ANIMATION_PLAY_STATE:n("animationPlayState"),ANIMATION_DURATION:n("animationDuration"),ANIMATION_NAME:n("animationName"),ANIMATION_TIMING:n("animationTimingFunction"),ANIMATION_DIRECTION:n("animationDirection")},MEDIA:{sm:"(max-width: 600px)","gt-sm":"(min-width: 600px)",md:"(min-width: 600px) and (max-width: 960px)","gt-md":"(min-width: 960px)",lg:"(min-width: 960px) and (max-width: 1200px)","gt-lg":"(min-width: 1200px)"},MEDIA_PRIORITY:["gt-lg","lg","gt-md","md","gt-sm","sm"]}}angular.module("material.core").factory("$mdConstant",e),e.$inject=["$$rAF","$sniffer"]}(),function(){function e(e,t){function n(){return[].concat(v)}function r(){return v.length}function o(e){return v.length&&e>-1&&e<v.length}function a(e){return e?o(f(e)+1):!1}function i(e){return e?o(f(e)-1):!1}function c(e){return o(e)?v[e]:null}function l(e,t){return v.filter(function(n){return n[e]===t})}function s(e,t){return e?(angular.isNumber(t)||(t=v.length),v.splice(t,0,e),f(e)):-1}function u(e){d(e)&&v.splice(f(e),1)}function f(e){return v.indexOf(e)}function d(e){return e&&f(e)>-1}function h(){return v.length?v[0]:null}function p(){return v.length?v[v.length-1]:null}function g(e,n,r,a){r=r||m;for(var i=f(n);;){if(!o(i))return null;var c=i+(e?-1:1),l=null;if(o(c)?l=v[c]:t&&(l=e?p():h(),c=f(l)),null===l||c===a)return null;if(r(l))return l;angular.isUndefined(a)&&(a=c),i=c}}var m=function(){return!0};e&&!angular.isArray(e)&&(e=Array.prototype.slice.call(e)),t=!!t;var v=e||[];return{items:n,count:r,inRange:o,contains:d,indexOf:f,itemAt:c,findBy:l,add:s,remove:u,first:h,last:p,next:angular.bind(null,g,!1),previous:angular.bind(null,g,!0),hasPrevious:i,hasNext:a}}angular.module("material.core").config(["$provide",function(t){t.decorator("$mdUtil",["$delegate",function(t){return t.iterator=e,t}])}])}(),function(){function e(e,t,n){function r(e){var t=f[e];angular.isUndefined(t)&&(t=f[e]=o(e));var n=h[t];return angular.isUndefined(n)&&(n=a(t)),n}function o(t){return e.MEDIA[t]||("("!==t.charAt(0)?"("+t+")":t)}function a(e){var t=d[e]=n.matchMedia(e);return t.addListener(i),h[t.media]=!!t.matches}function i(e){t.$evalAsync(function(){h[e.media]=!!e.matches})}function c(e){return d[e]}function l(t,n){for(var r=0;r<e.MEDIA_PRIORITY.length;r++){var o=e.MEDIA_PRIORITY[r];if(d[f[o]].matches){var a=u(t,n+"-"+o);if(t[a])return t[a]}}return t[u(t,n)]}function s(t,n,r){var o=[];return t.forEach(function(t){var a=u(n,t);n[a]&&o.push(n.$observe(a,angular.bind(void 0,r,null)));for(var i in e.MEDIA){if(a=u(n,t+"-"+i),!n[a])return;o.push(n.$observe(a,angular.bind(void 0,r,i)))}}),function(){o.forEach(function(e){e()})}}function u(e,t){return p[t]||(p[t]=e.$normalize(t))}var f={},d={},h={},p={};return r.getResponsiveAttribute=l,r.getQuery=c,r.watchResponsiveAttributes=s,r}angular.module("material.core").factory("$mdMedia",e),e.$inject=["$mdConstant","$rootScope","$window"]}(),function(){var e=["0","0","0"];angular.module("material.core").factory("$mdUtil",["$cacheFactory","$document","$timeout","$q","$window","$mdConstant",function(t,n,r,o,a,i){function c(e){return e[0]||e}var l;return l={now:window.performance?angular.bind(window.performance,window.performance.now):Date.now,clientRect:function(e,t,n){var r=c(e);t=c(t||r.offsetParent||document.body);var o=r.getBoundingClientRect(),a=n?t.getBoundingClientRect():{left:0,top:0,width:0,height:0};return{left:o.left-a.left,top:o.top-a.top,width:o.width,height:o.height}},offsetRect:function(e,t){return l.clientRect(e,t,!0)},disableScrollAround:function(e){function t(){p?c.attr("style",p):c[0].removeAttribute("style"),v.css("position","static");var e=a.getComputedStyle(c[0]);r(e);var t=c[0].clientWidth;"border-box"==e.boxSizing&&(t-=parseFloat(e.paddingLeft,10),t-=parseFloat(e.paddingRight,10)),m.css({"max-width":t+"px"}),c.css("position","relative"),v.css("position","absolute")}function r(e){var t=!l.floatingScrollbars()&&"hidden"!=e.overflowY&&(v[0].clientHeight>s.clientHeight||$),n=-1*(d-parseFloat(g.paddingTop,10));c.css("padding-top","0px"),t&&c.css("overflow-y","scroll"),v.css("top",n+"px");var r=parseFloat(e.height,10);return"border-box"==e.boxSizing&&(r-=parseFloat(e.paddingTop,10),r-=parseFloat(e.paddingBottom,10)),m.css("height",r+"px"),t}function o(e){return e instanceof angular.element&&(e=e[0]),e.scrollHeight>e.offsetHeight}for(var i,c,s,u,f=e instanceof angular.element?e[0]:e;f=this.getClosest(f,"MD-CONTENT",!0);)o(f)?c=angular.element(f):i=f;c||(c=angular.element(!i||n[0].body.scrollTop||n[0].documentElement.scrollTop?n[0].body:i)),"BODY"==c[0].nodeName&&n[0].documentElement.scrollTop?(s=n[0].documentElement,u=!0):s=c[0];var d=s.scrollTop,h=s.clientWidth,p=c.attr("style"),g=a.getComputedStyle(c[0]),m=angular.element('<div class="md-virtual-scroll-container"><div class="md-virtual-scroller"></div></div>'),v=m.children().eq(0);v.append(c[0].childNodes),c.append(m);var $=h<s.clientWidth;return r(g),v.attr("layout-margin",c.attr("layout-margin")),v.css({display:g.display,"-webkit-flex-direction":g.webkitFlexDirection,"-ms-flex-direction":g.msFlexDirection,"flex-direction":g.flexDirection,"-webkit-align-items":g.webkitAlignItems,"-ms-flex-align":g.msFlexAlign,"align-items":g.alignItems,"-webkit-justify-content":g.webkitJustifyContent,"-ms-flex-pack":g.msFlexPack,"justify-content":g.justifyContent,"-webkit-flex":g.webkitFlex,"-ms-flex":g.msFlex,flex:g.flex}),/flex$/.test(g.display)&&v.css("height","100%"),t(),angular.element(a).on("resize",t),function(){c.append(v[0].childNodes),m.remove(),angular.element(a).off("resize",t),c.attr("style",p||!1),u?n[0].documentElement.scrollTop=d:c[0].scrollTop=d}},floatingScrollbars:function(){if(void 0===this.floatingScrollbars.cached){var e=angular.element('<div style="width: 100%; z-index: -1; position: absolute; height: 35px; overflow-y: scroll"><div style="height: 60;"></div></div>');n[0].body.appendChild(e[0]),this.floatingScrollbars.cached=e[0].offsetWidth==e[0].childNodes[0].offsetWidth,e.remove()}return this.floatingScrollbars.cached},forceFocus:function(e){var t=e[0]||e;document.addEventListener("click",function r(e){e.target===t&&e.$focus&&(t.focus(),e.stopImmediatePropagation(),e.preventDefault(),t.removeEventListener("click",r))},!0);var n=document.createEvent("MouseEvents");n.initMouseEvent("click",!1,!0,window,{},0,0,0,0,!1,!1,!1,!1,0,null),n.$material=!0,n.$focus=!0,t.dispatchEvent(n)},transitionEndPromise:function(e,t){function n(t){t&&t.target!==e[0]||(e.off(i.CSS.TRANSITIONEND,n),a.resolve())}t=t||{};var a=o.defer();return e.on(i.CSS.TRANSITIONEND,n),t.timeout&&r(n,t.timeout),a.promise},fakeNgModel:function(){return{$fake:!0,$setTouched:angular.noop,$setViewValue:function(e){this.$viewValue=e,this.$render(e),this.$viewChangeListeners.forEach(function(e){e()})},$isEmpty:function(e){return 0===(""+e).length},$parsers:[],$formatters:[],$viewChangeListeners:[],$render:angular.noop}},debounce:function(e,t,n,o){var a;return function(){var i=n,c=Array.prototype.slice.call(arguments);r.cancel(a),a=r(function(){a=void 0,e.apply(i,c)},t||10,o)}},throttle:function(e,t){var n;return function(){var r=this,o=arguments,a=l.now();(!n||a-n>t)&&(e.apply(r,o),n=a)}},time:function(e){var t=l.now();return e(),l.now()-t},nextUid:function(){for(var t,n=e.length;n;){if(n--,t=e[n].charCodeAt(0),57==t)return e[n]="A",e.join("");if(90!=t)return e[n]=String.fromCharCode(t+1),e.join("");e[n]="0"}return e.unshift("0"),e.join("")},disconnectScope:function(e){if(e&&e.$root!==e&&!e.$$destroyed){var t=e.$parent;e.$$disconnected=!0,t.$$childHead===e&&(t.$$childHead=e.$$nextSibling),t.$$childTail===e&&(t.$$childTail=e.$$prevSibling),e.$$prevSibling&&(e.$$prevSibling.$$nextSibling=e.$$nextSibling),e.$$nextSibling&&(e.$$nextSibling.$$prevSibling=e.$$prevSibling),e.$$nextSibling=e.$$prevSibling=null}},reconnectScope:function(e){if(e&&e.$root!==e&&e.$$disconnected){var t=e,n=t.$parent;t.$$disconnected=!1,t.$$prevSibling=n.$$childTail,n.$$childHead?(n.$$childTail.$$nextSibling=t,n.$$childTail=t):n.$$childHead=n.$$childTail=t}},getClosest:function(e,t,n){if(e instanceof angular.element&&(e=e[0]),t=t.toUpperCase(),n&&(e=e.parentNode),!e)return null;do if(e.nodeName===t)return e;while(e=e.parentNode);return null},extractElementByName:function(e,t){for(var n=0,r=e.length;r>n;n++)if(e[n].nodeName.toLowerCase()===t)return angular.element(e[n]);return e},initOptionalProperties:function(e,t,n){n=n||{},angular.forEach(e.$$isolateBindings,function(r,o){if(r.optional&&angular.isUndefined(e[o])){var a=t.hasOwnProperty(t.$normalize(r.attrName));e[o]=angular.isDefined(n[o])?n[o]:a}})}}}]),angular.element.prototype.focus=angular.element.prototype.focus||function(){return this.length&&this[0].focus(),this},angular.element.prototype.blur=angular.element.prototype.blur||function(){return this.length&&this[0].blur(),this}}(),function(){function e(e,t,n){function r(e,n,r){var o=e[0]||e;!o||o.hasAttribute(n)&&0!==o.getAttribute(n).length||c(o,n)||(r=angular.isString(r)?r.trim():"",r.length?e.attr(n,r):t.warn('ARIA: Attribute "',n,'", required for accessibility, is missing on node:',o))}function o(t,n,o){e(function(){r(t,n,o())})}function a(e,t){o(e,t,function(){return i(e)})}function i(e){return e.text().trim()}function c(e,t){function r(e){var t=e.currentStyle?e.currentStyle:n.getComputedStyle(e);return"none"===t.display}var o=e.hasChildNodes(),a=!1;if(o)for(var i=e.childNodes,c=0;c<i.length;c++){var l=i[c];1===l.nodeType&&l.hasAttribute(t)&&(r(l)||(a=!0))}return a}return{expect:r,expectAsync:o,expectWithText:a}}angular.module("material.core").service("$mdAria",e),e.$inject=["$$rAF","$log","$window"]}(),function(){function e(e,t,n,r,o,a){this.compile=function(i){var c=i.templateUrl,l=i.template||"",s=i.controller,u=i.controllerAs,f=i.resolve||{},d=i.locals||{},h=i.transformTemplate||angular.identity,p=i.bindToController;return angular.forEach(f,function(e,t){f[t]=angular.isString(e)?n.get(e):n.invoke(e)}),angular.extend(f,d),f.$template=c?t.get(c,{cache:a}).then(function(e){return e.data}):e.when(l),e.all(f).then(function(e){var t=h(e.$template),n=i.element||angular.element("<div>").html(t.trim()).contents(),a=r(n);return{locals:e,element:n,link:function(t){if(e.$scope=t,s){var r=o(s,e,!0);p&&angular.extend(r.instance,e);var i=r();n.data("$ngControllerController",i),n.children().data("$ngControllerController",i),u&&(t[u]=i)}return a(t)}}})}}angular.module("material.core").service("$mdCompiler",e),e.$inject=["$q","$http","$injector","$compile","$controller","$templateCache"]}(),function(e){function t(){}function n(t,n,r){function o(e,t,n){var r=d[t.replace(/^\$md./,"")];if(!r)throw new Error("Failed to register element with handler "+t+". Available handlers: "+Object.keys(d).join(", "));return r.registerElement(e,n)}function a(e,n){var r=new t(e);return angular.extend(r,n),d[e]=r,f}var c=navigator.userAgent||navigator.vendor||window.opera,s=c.match(/ipad|iphone|ipod/i),u=c.match(/android/i),f={handler:a,register:o,isHijackingClicks:(s||u)&&!e&&!h};return f.isHijackingClicks&&f.handler("click",{options:{maxDistance:6},onEnd:function(e,t){t.distance<this.state.options.maxDistance&&this.dispatchEvent(e,"click")}}),f.handler("press",{onStart:function(e,t){this.dispatchEvent(e,"$md.pressdown")},onEnd:function(e,t){this.dispatchEvent(e,"$md.pressup")}}).handler("hold",{options:{maxDistance:6,delay:500},onCancel:function(){r.cancel(this.state.timeout)},onStart:function(e,t){return this.state.registeredParent?(this.state.pos={x:t.x,y:t.y},void(this.state.timeout=r(angular.bind(this,function(){this.dispatchEvent(e,"$md.hold"),this.cancel()}),this.state.options.delay,!1))):this.cancel()},onMove:function(e,t){e.preventDefault();var n=this.state.pos.x-t.x,r=this.state.pos.y-t.y;Math.sqrt(n*n+r*r)>this.options.maxDistance&&this.cancel()},onEnd:function(){this.onCancel()}}).handler("drag",{options:{minDistance:6,horizontal:!0,cancelMultiplier:1.5},onStart:function(e){this.state.registeredParent||this.cancel()},onMove:function(e,t){var n,r;e.preventDefault(),this.state.dragPointer?this.dispatchDragMove(e):(this.state.options.horizontal?(n=Math.abs(t.distanceX)>this.state.options.minDistance,r=Math.abs(t.distanceY)>this.state.options.minDistance*this.state.options.cancelMultiplier):(n=Math.abs(t.distanceY)>this.state.options.minDistance,r=Math.abs(t.distanceX)>this.state.options.minDistance*this.state.options.cancelMultiplier),n?(this.state.dragPointer=i(e),l(e,this.state.dragPointer),this.dispatchEvent(e,"$md.dragstart",this.state.dragPointer)):r&&this.cancel())},dispatchDragMove:n.throttle(function(e){this.state.isRunning&&(l(e,this.state.dragPointer),this.dispatchEvent(e,"$md.drag",this.state.dragPointer))}),onEnd:function(e,t){this.state.dragPointer&&(l(e,this.state.dragPointer),this.dispatchEvent(e,"$md.dragend",this.state.dragPointer))}}).handler("swipe",{options:{minVelocity:.65,minDistance:10},onEnd:function(e,t){if(Math.abs(t.velocityX)>this.state.options.minVelocity&&Math.abs(t.distanceX)>this.state.options.minDistance){var n="left"==t.directionX?"$md.swipeleft":"$md.swiperight";this.dispatchEvent(e,n)}}})}function r(e){this.name=e,this.state={}}function o(t){function n(e,t,n){n=n||u;var r=new angular.element.Event(t);r.$material=!0,r.pointer=n,r.srcEvent=e,angular.extend(r,{clientX:n.x,clientY:n.y,screenX:n.x,screenY:n.y,pageX:n.x,pageY:n.y,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey,metaKey:e.metaKey}),angular.element(n.target).trigger(r)}function o(e,t,n){n=n||u;var r;"click"===t?(r=document.createEvent("MouseEvents"),r.initMouseEvent("click",!0,!0,window,e.detail,n.x,n.y,n.x,n.y,e.ctrlKey,e.altKey,e.shiftKey,e.metaKey,e.button,e.relatedTarget||null)):(r=document.createEvent("CustomEvent"),r.initCustomEvent(t,!0,!0,{})),r.$material=!0,r.pointer=n,r.srcEvent=e,n.target.dispatchEvent(r)}var a="undefined"!=typeof e&&angular.element===e;return r.prototype={options:{},dispatchEvent:a?n:o,onStart:angular.noop,onMove:angular.noop,onEnd:angular.noop,onCancel:angular.noop,start:function(e,t){if(!this.state.isRunning){var n=this.getNearestParent(e.target),r=n&&n.$mdGesture[this.name]||{};this.state={isRunning:!0,options:angular.extend({},this.options,r),registeredParent:n},this.onStart(e,t)}},move:function(e,t){this.state.isRunning&&this.onMove(e,t)},end:function(e,t){this.state.isRunning&&(this.onEnd(e,t),this.state.isRunning=!1)},cancel:function(e,t){this.onCancel(e,t),this.state={}},getNearestParent:function(e){for(var t=e;t;){if((t.$mdGesture||{})[this.name])return t;t=t.parentNode}return null},registerElement:function(e,t){function n(){delete e[0].$mdGesture[r.name],e.off("$destroy",n)}var r=this;return e[0].$mdGesture=e[0].$mdGesture||{},e[0].$mdGesture[this.name]=t||{},e.on("$destroy",n),n}},r}function a(e,t){function n(e,n){var r;for(var o in d)r=d[o],r instanceof t&&("start"===e&&r.cancel(),r[e](n,u))}function r(e){if(!u){var t=+Date.now();f&&!c(e,f)&&t-f.endTime<1500||(u=i(e),n("start",e))}}function o(e){u&&c(e,u)&&(l(e,u),n("move",e))}function a(e){u&&c(e,u)&&(l(e,u),u.endTime=+Date.now(),n("end",e),f=u,u=null)}document.contains||(document.contains=function(e){return document.body.contains(e)}),!p&&e.isHijackingClicks&&(document.addEventListener("click",function(e){var t=0===e.clientX&&0===e.clientY;t||e.$material||(e.preventDefault(),e.stopPropagation())},!0),p=!0);var s="mousedown touchstart pointerdown",h="mousemove touchmove pointermove",g="mouseup mouseleave touchend touchcancel pointerup pointercancel";angular.element(document).on(s,r).on(h,o).on(g,a).on("$$mdGestureReset",function(){f=u=null})}function i(e){var t=s(e),n={startTime:+Date.now(),target:e.target,type:e.type.charAt(0)};return n.startX=n.x=t.pageX,n.startY=n.y=t.pageY,n}function c(e,t){return e&&t&&e.type.charAt(0)===t.type}function l(e,t){var n=s(e),r=t.x=n.pageX,o=t.y=n.pageY;t.distanceX=r-t.startX,t.distanceY=o-t.startY,t.distance=Math.sqrt(t.distanceX*t.distanceX+t.distanceY*t.distanceY),t.directionX=t.distanceX>0?"right":t.distanceX<0?"left":"",t.directionY=t.distanceY>0?"up":t.distanceY<0?"down":"",t.duration=+Date.now()-t.startTime,t.velocityX=t.distanceX/t.duration,t.velocityY=t.distanceY/t.duration}function s(e){return e=e.originalEvent||e,e.touches&&e.touches[0]||e.changedTouches&&e.changedTouches[0]||e}var u,f,d={},h=!1,p=!1;angular.module("material.core.gestures",[]).provider("$mdGesture",t).factory("$$MdGestureHandler",o).run(a),t.prototype={skipClickHijack:function(){return h=!0},$get:["$$MdGestureHandler","$$rAF","$timeout",function(e,t,r){return new n(e,t,r)}]},o.$inject=["$$rAF"],a.$inject=["$mdGesture","$$MdGestureHandler"]}(window.jQuery),function(){function e(){function e(e){function t(e){return c.optionsFactory=e.options,c.methods=(e.methods||[]).concat(a),l}function n(e,t){return i[e]=t,l}function r(t,n){if(n=n||{},n.methods=n.methods||[],n.options=n.options||function(){return{}},/^cancel|hide|show$/.test(t))throw new Error("Preset '"+t+"' in "+e+" is reserved!");if(n.methods.indexOf("_options")>-1)throw new Error("Method '_options' in "+e+" is reserved!");return c.presets[t]={methods:n.methods.concat(a),optionsFactory:n.options,argOption:n.argOption},l}function o(t,n,r){function o(e){return e&&e._options&&(e=e._options),u.show(angular.extend({},s,e))}function a(t,n){var o={};return o[e]=f,r.invoke(t||function(){return n},{},o)}var l,s,u=t(),f={hide:u.hide,cancel:u.cancel,show:o};return l=c.methods||[],s=a(c.optionsFactory,{}),angular.forEach(i,function(e,t){f[t]=e}),angular.forEach(c.presets,function(e,t){function n(e){this._options=angular.extend({},r,e)}var r=a(e.optionsFactory,{}),o=(e.methods||[]).concat(l);if(angular.extend(r,{$type:t}),angular.forEach(o,function(e){n.prototype[e]=function(t){return this._options[e]=t,this}}),e.argOption){var i="show"+t.charAt(0).toUpperCase()+t.slice(1);f[i]=function(e){var n=f[t](e);return f.show(n)}}f[t]=function(t){return arguments.length&&e.argOption&&!angular.isObject(t)&&!angular.isArray(t)?(new n)[e.argOption](t):new n(t)}}),f}var a=["onHide","onShow","onRemove"],i={},c={presets:{}},l={setDefaults:t,addPreset:r,addMethod:n,$get:o};return l.addPreset("build",{methods:["controller","controllerAs","resolve","template","templateUrl","themable","transformTemplate","parent"]}),o.$inject=["$$interimElement","$animate","$injector"],l}function t(e,t,n,r,o,a,i,c,l){function s(e){return e&&angular.isString(e)?e.replace(/\{\{/g,u).replace(/}}/g,f):e}var u=i.startSymbol(),f=i.endSymbol(),d="{{"===u&&"}}"===f,h=d?angular.identity:s;return function(){function i(e){if(p.length)return d.cancel().then(function(){return i(e)});var t=new f(e);return p.push(t),t.show().then(function(){return t.deferred.promise})}function s(e){var t=p.shift();return t&&t.remove().then(function(){t.deferred.resolve(e)})}function u(e){var n=p.shift();return t.when(n&&n.remove().then(function(){n.deferred.reject(e)}))}function f(i){var s,u,f,p,g;return i=i||{},i=angular.extend({preserveScope:!1,scope:i.scope||n.$new(i.isolateScope),onShow:function(e,t,n){return a.enter(t,n.parent)},onRemove:function(e,n,r){return n&&a.leave(n)||t.when()}},i),i.template&&(i.template=h(i.template)),s={options:i,deferred:t.defer(),show:function(){var n;return n=i.skipCompile?t(function(e){e({locals:{},link:function(){return i.element}})}):c.compile(i),p=n.then(function(n){function a(){i.hideDelay&&(u=r(d.cancel,i.hideDelay))}if(angular.extend(n.locals,s.options),f=n.link(i.scope),angular.isFunction(i.parent)?i.parent=i.parent(i.scope,f,i):angular.isString(i.parent)&&(i.parent=angular.element(e[0].querySelector(i.parent))),!(i.parent||{}).length){var c;o[0]&&o[0].querySelector&&(c=o[0].querySelector(":not(svg) > body")),c||(c=o[0]),"#comment"==c.nodeName&&(c=e[0].body),i.parent=angular.element(c)}i.themable&&l(f);var h=i.onShow(i.scope,f,i);return t.when(h).then(function(){(i.onComplete||angular.noop)(i.scope,f,i),a()})},function(e){p=!0,s.deferred.reject(e)})},cancelTimeout:function(){u&&(r.cancel(u),u=void 0)},remove:function(){return s.cancelTimeout(),g=t.when(p).then(function(){var e=f?i.onRemove(i.scope,f,i):!0;return t.when(e).then(function(){i.preserveScope||i.scope.$destroy(),g=!0})})}}}var d,p=[];return d={show:i,hide:s,cancel:u}}}return e.$get=t,t.$inject=["$document","$q","$rootScope","$timeout","$rootElement","$animate","$interpolate","$mdCompiler","$mdTheming"],e}angular.module("material.core").provider("$$interimElement",e)}(),function(){function e(e,t){function n(e){return e&&""!==e}var r,o=[],a={};return r={notFoundError:function(t){e.error("No instance found for handle",t)},getInstances:function(){return o},get:function(e){if(!n(e))return null;var t,r,a;for(t=0,r=o.length;r>t;t++)if(a=o[t],a.$$mdHandle===e)return a;return null},register:function(e,t){function n(){var t=o.indexOf(e);-1!==t&&o.splice(t,1)}function r(){var n=a[t];n&&(n.resolve(e),delete a[t])}return t?(e.$$mdHandle=t,o.push(e),r(),n):angular.noop},when:function(e){if(n(e)){var o=t.defer(),i=r.get(e);return i?o.resolve(i):a[e]=o,o.promise}return t.reject("Invalid `md-component-id` value.")}}}angular.module("material.core").factory("$mdComponentRegistry",e),e.$inject=["$log","$q"]}(),function(){function e(e){return{controller:angular.noop,link:function(t,n,r){r.hasOwnProperty("mdInkRippleCheckbox")?e.attachCheckboxBehavior(t,n):e.attachButtonBehavior(t,n)}}}function t(e,t){function n(e,t,n){return i(e,t,angular.extend({fullRipple:!0,isMenuItem:t.hasClass("md-menu-item"),center:!1,dimBackground:!0},n))}function r(e,t,n){return i(e,t,angular.extend({center:!0,dimBackground:!1,fitRipple:!0},n))}function o(e,t,n){return i(e,t,angular.extend({center:!1,dimBackground:!0,outline:!1,rippleSize:"full"},n))}function a(e,t,n){return i(e,t,angular.extend({center:!1,dimBackground:!0,outline:!1,rippleSize:"full"},n))}function i(n,r,o){function a(){var e=r.data("$mdRippleContainer");return e?e:(e=angular.element('<div class="md-ripple-container">'),r.append(e),r.data("$mdRippleContainer",e),e)}function i(e){function t(e){var t="#"===e.charAt(0)?e.substr(1):e,n=t.length/3,r=t.substr(0,n),o=t.substr(n,n),a=t.substr(2*n);return 1===n&&(r+=r,o+=o,a+=a),"rgba("+parseInt(r,16)+","+parseInt(o,16)+","+parseInt(a,16)+",0.1)"}function n(e){return e.replace(")",", 0.1)").replace("(","a(")}if(e)return 0===e.indexOf("rgba")?e.replace(/\d?\.?\d*\s*\)\s*$/,"0.1)"):0===e.indexOf("rgb")?n(e):0===e.indexOf("#")?t(e):void 0}function c(e,n){m.splice(m.indexOf(e),1),0===m.length&&a().css({backgroundColor:""}),t(function(){e.remove()},n,!1)}function l(e){var t=m.indexOf(e),n=v[t]||{},r=m.length>1?!1:b,a=m.length>1?!1:A;r||n.animating||a?e.addClass("md-ripple-visible"):e&&(e.removeClass("md-ripple-visible"),o.outline&&e.css({width:h+"px",height:h+"px",marginLeft:-1*h+"px",marginTop:-1*h+"px"}),c(e,o.outline?450:650))}function s(n,c){function s(e){var t=angular.element('<div class="md-ripple" data-counter="'+g++ +'">');return m.unshift(t),v.unshift({animating:!0}),d.append(t),e&&t.css(e),t}function u(e,t){var n,r,a,i=d.prop("offsetWidth"),c=d.prop("offsetHeight");return o.isMenuItem?r=Math.sqrt(Math.pow(i,2)+Math.pow(c,2)):o.outline?(a=w.getBoundingClientRect(),e-=a.left,t-=a.top,i=Math.max(e,i-e),c=Math.max(t,c-t),r=2*Math.sqrt(Math.pow(i,2)+Math.pow(c,2))):(n=o.fullRipple?1.1:.8,r=Math.sqrt(Math.pow(i,2)+Math.pow(c,2))*n,o.fitRipple&&(r=Math.min(c,i,r))),r}function f(e,t,n){function r(e){return e.replace("rgba","rgb").replace(/,[^\),]+\)/,")")}var a=w.getBoundingClientRect(),i={backgroundColor:r(C),borderColor:r(C),width:e+"px",height:e+"px"};return o.outline?(i.width=0,i.height=0):i.marginLeft=i.marginTop=e*-.5+"px",o.center?i.left=i.top="50%":(i.left=Math.round((t-a.left)/d.prop("offsetWidth")*100)+"%",i.top=Math.round((n-a.top)/d.prop("offsetHeight")*100)+"%"),i}C=i(r.attr("md-ink-ripple"))||i(e.getComputedStyle(o.colorElement[0]).color||"rgb(0, 0, 0)");var d=a(),p=u(n,c),$=f(p,n,c),b=s($),A=m.indexOf(b),y=v[A]||{};return h=p,y.animating=!0,t(function(){o.dimBackground&&d.css({backgroundColor:C}),b.addClass("md-ripple-placed md-ripple-scaled"),b.css(o.outline?{borderWidth:.5*p+"px",marginLeft:p*-.5+"px",marginTop:p*-.5+"px"}:{left:"50%",top:"50%"}),l(b),t(function(){y.animating=!1,l(b)},o.outline?450:225,!1)},0,!1),b}function u(e){d()&&(s(e.pointer.x,e.pointer.y),A=!0)}function f(){A=!1;var e=m[m.length-1];t(function(){l(e)},0,!1)}function d(){function e(e){return e&&e.hasAttribute&&e.hasAttribute("disabled")}var t=w.parentNode,n=t&&t.parentNode,r=n&&n.parentNode;return!(e(w)||e(t)||e(n)||e(r))}if(r.controller("mdNoInk"))return angular.noop;o=angular.extend({colorElement:r,mousedown:!0,hover:!0,focus:!0,center:!1,mousedownPauseTime:150,dimBackground:!1,outline:!1,fullRipple:!0,isMenuItem:!1,fitRipple:!1},o);var h,p=r.controller("mdInkRipple")||{},g=0,m=[],v=[],$=r.attr("md-highlight"),b=!1,A=!1,w=r[0],y=r.attr("md-ripple-size"),C=i(r.attr("md-ink-ripple"))||i(o.colorElement.length&&e.getComputedStyle(o.colorElement[0]).color||"rgb(0, 0, 0)");switch(y){case"full":o.fullRipple=!0;break;case"partial":o.fullRipple=!1}return o.mousedown&&r.on("$md.pressdown",u).on("$md.pressup",f),p.createRipple=s,$&&n.$watch($,function(e){b=e,b&&!m.length&&t(function(){s(0,0)},0,!1),angular.forEach(m,l)}),function(){r.off("$md.pressdown",u).off("$md.pressup",f),a().remove()}}return{attachButtonBehavior:n,attachCheckboxBehavior:r,attachTabBehavior:o,attachListControlBehavior:a,attach:i}}function n(){return function(){return{controller:angular.noop}}}angular.module("material.core").factory("$mdInkRipple",t).directive("mdInkRipple",e).directive("mdNoInk",n()).directive("mdNoBar",n()).directive("mdNoStretch",n()),e.$inject=["$mdInkRipple"],t.$inject=["$window","$timeout"]}(),function(){angular.module("material.core.theming.palette",[]).constant("$mdColorPalette",{red:{50:"#ffebee",100:"#ffcdd2",200:"#ef9a9a",300:"#e57373",400:"#ef5350",500:"#f44336",600:"#e53935",700:"#d32f2f",800:"#c62828",900:"#b71c1c",A100:"#ff8a80",A200:"#ff5252",A400:"#ff1744",A700:"#d50000",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 300 400 A100",contrastStrongLightColors:"500 600 700 A200 A400 A700"},pink:{50:"#fce4ec",100:"#f8bbd0",200:"#f48fb1",300:"#f06292",400:"#ec407a",500:"#e91e63",600:"#d81b60",700:"#c2185b",800:"#ad1457",900:"#880e4f",A100:"#ff80ab",A200:"#ff4081",A400:"#f50057",A700:"#c51162",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 300 400 A100",contrastStrongLightColors:"500 600 A200 A400 A700"},purple:{50:"#f3e5f5",100:"#e1bee7",200:"#ce93d8",300:"#ba68c8",400:"#ab47bc",500:"#9c27b0",600:"#8e24aa",700:"#7b1fa2",800:"#6a1b9a",900:"#4a148c",A100:"#ea80fc",A200:"#e040fb",A400:"#d500f9",A700:"#aa00ff",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 A100",contrastStrongLightColors:"300 400 A200 A400 A700"},"deep-purple":{50:"#ede7f6",100:"#d1c4e9",200:"#b39ddb",300:"#9575cd",400:"#7e57c2",500:"#673ab7",600:"#5e35b1",700:"#512da8",800:"#4527a0",900:"#311b92",A100:"#b388ff",A200:"#7c4dff",A400:"#651fff",A700:"#6200ea",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 A100",contrastStrongLightColors:"300 400 A200"},indigo:{50:"#e8eaf6",100:"#c5cae9",200:"#9fa8da",300:"#7986cb",400:"#5c6bc0",500:"#3f51b5",600:"#3949ab",700:"#303f9f",800:"#283593",900:"#1a237e",A100:"#8c9eff",A200:"#536dfe",A400:"#3d5afe",A700:"#304ffe",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 A100",contrastStrongLightColors:"300 400 A200 A400"},blue:{50:"#e3f2fd",100:"#bbdefb",200:"#90caf9",300:"#64b5f6",400:"#42a5f5",500:"#2196f3",600:"#1e88e5",700:"#1976d2",800:"#1565c0",900:"#0d47a1",A100:"#82b1ff",A200:"#448aff",A400:"#2979ff",A700:"#2962ff",contrastDefaultColor:"light",contrastDarkColors:"100 200 300 400 A100",contrastStrongLightColors:"500 600 700 A200 A400 A700"},"light-blue":{50:"#e1f5fe",100:"#b3e5fc",200:"#81d4fa",300:"#4fc3f7",400:"#29b6f6",500:"#03a9f4",600:"#039be5",700:"#0288d1",800:"#0277bd",900:"#01579b",A100:"#80d8ff",A200:"#40c4ff",A400:"#00b0ff",A700:"#0091ea",contrastDefaultColor:"dark",contrastLightColors:"500 600 700 800 900 A700",contrastStrongLightColors:"500 600 700 800 A700"},cyan:{50:"#e0f7fa",100:"#b2ebf2",200:"#80deea",300:"#4dd0e1",400:"#26c6da",500:"#00bcd4",600:"#00acc1",700:"#0097a7",800:"#00838f",900:"#006064",A100:"#84ffff",A200:"#18ffff",A400:"#00e5ff",A700:"#00b8d4",contrastDefaultColor:"dark",contrastLightColors:"500 600 700 800 900",contrastStrongLightColors:"500 600 700 800"},teal:{50:"#e0f2f1",100:"#b2dfdb",200:"#80cbc4",300:"#4db6ac",400:"#26a69a",500:"#009688",600:"#00897b",700:"#00796b",800:"#00695c",900:"#004d40",A100:"#a7ffeb",A200:"#64ffda",A400:"#1de9b6",A700:"#00bfa5",contrastDefaultColor:"dark",contrastLightColors:"500 600 700 800 900",contrastStrongLightColors:"500 600 700"},green:{50:"#e8f5e9",100:"#c8e6c9",200:"#a5d6a7",300:"#81c784",400:"#66bb6a",500:"#4caf50",600:"#43a047",700:"#388e3c",800:"#2e7d32",900:"#1b5e20",A100:"#b9f6ca",A200:"#69f0ae",A400:"#00e676",A700:"#00c853",contrastDefaultColor:"dark",contrastLightColors:"500 600 700 800 900",contrastStrongLightColors:"500 600 700"},"light-green":{50:"#f1f8e9",100:"#dcedc8",200:"#c5e1a5",300:"#aed581",400:"#9ccc65",500:"#8bc34a",600:"#7cb342",700:"#689f38",800:"#558b2f",900:"#33691e",A100:"#ccff90",A200:"#b2ff59",A400:"#76ff03",A700:"#64dd17",contrastDefaultColor:"dark",contrastLightColors:"800 900",contrastStrongLightColors:"800 900"},lime:{50:"#f9fbe7",100:"#f0f4c3",200:"#e6ee9c",300:"#dce775",400:"#d4e157",500:"#cddc39",600:"#c0ca33",700:"#afb42b",800:"#9e9d24",900:"#827717",A100:"#f4ff81",A200:"#eeff41",A400:"#c6ff00",A700:"#aeea00",contrastDefaultColor:"dark",contrastLightColors:"900",contrastStrongLightColors:"900"},yellow:{50:"#fffde7",100:"#fff9c4",200:"#fff59d",300:"#fff176",400:"#ffee58",500:"#ffeb3b",600:"#fdd835",700:"#fbc02d",800:"#f9a825",900:"#f57f17",A100:"#ffff8d",A200:"#ffff00",A400:"#ffea00",A700:"#ffd600",contrastDefaultColor:"dark"},amber:{50:"#fff8e1",100:"#ffecb3",200:"#ffe082",300:"#ffd54f",400:"#ffca28",500:"#ffc107",600:"#ffb300",700:"#ffa000",800:"#ff8f00",900:"#ff6f00",A100:"#ffe57f",A200:"#ffd740",A400:"#ffc400",A700:"#ffab00",contrastDefaultColor:"dark"},orange:{50:"#fff3e0",100:"#ffe0b2",200:"#ffcc80",300:"#ffb74d",400:"#ffa726",500:"#ff9800",600:"#fb8c00",700:"#f57c00",800:"#ef6c00",900:"#e65100",A100:"#ffd180",A200:"#ffab40",A400:"#ff9100",A700:"#ff6d00",contrastDefaultColor:"dark",contrastLightColors:"800 900",contrastStrongLightColors:"800 900"},"deep-orange":{50:"#fbe9e7",100:"#ffccbc",200:"#ffab91",300:"#ff8a65",400:"#ff7043",500:"#ff5722",600:"#f4511e",700:"#e64a19",800:"#d84315",900:"#bf360c",A100:"#ff9e80",A200:"#ff6e40",A400:"#ff3d00",A700:"#dd2c00",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 300 400 A100 A200",contrastStrongLightColors:"500 600 700 800 900 A400 A700"},brown:{50:"#efebe9",100:"#d7ccc8",200:"#bcaaa4",300:"#a1887f",400:"#8d6e63",500:"#795548",600:"#6d4c41",700:"#5d4037",800:"#4e342e",900:"#3e2723",A100:"#d7ccc8",A200:"#bcaaa4",A400:"#8d6e63",A700:"#5d4037",contrastDefaultColor:"light",contrastDarkColors:"50 100 200",contrastStrongLightColors:"300 400"},grey:{0:"#ffffff",50:"#fafafa",100:"#f5f5f5",200:"#eeeeee",
300:"#e0e0e0",400:"#bdbdbd",500:"#9e9e9e",600:"#757575",700:"#616161",800:"#424242",900:"#212121",1000:"#000000",A100:"#ffffff",A200:"#eeeeee",A400:"#bdbdbd",A700:"#616161",contrastDefaultColor:"dark",contrastLightColors:"600 700 800 900"},"blue-grey":{50:"#eceff1",100:"#cfd8dc",200:"#b0bec5",300:"#90a4ae",400:"#78909c",500:"#607d8b",600:"#546e7a",700:"#455a64",800:"#37474f",900:"#263238",A100:"#cfd8dc",A200:"#b0bec5",A400:"#78909c",A700:"#455a64",contrastDefaultColor:"light",contrastDarkColors:"50 100 200 300",contrastStrongLightColors:"400 500"}})}(),function(){function e(e){function t(e,t){return t=t||{},l[e]=o(e,t),m}function n(e,t){return o(e,angular.extend({},l[e]||{},t))}function o(e,t){var n=y.filter(function(e){return!t[e]});if(n.length)throw new Error("Missing colors %1 in palette %2!".replace("%1",n.join(", ")).replace("%2",e));return t}function a(e,t){if(s[e])return s[e];t=t||"default";var n="string"==typeof t?s[t]:t,r=new i(e);return n&&angular.forEach(n.colors,function(e,t){r.colors[t]={name:e.name,hues:angular.extend({},e.hues)}}),s[e]=r,r}function i(e){function t(e){if(e=0===arguments.length?!0:!!e,e!==n.isDark){n.isDark=e,n.foregroundPalette=n.isDark?d:f,n.foregroundShadow=n.isDark?h:p;var t=n.isDark?w:A,r=n.isDark?A:w;return angular.forEach(t,function(e,t){var o=n.colors[t],a=r[t];if(o)for(var i in o.hues)o.hues[i]===a[i]&&(o.hues[i]=e[i])}),n}}var n=this;n.name=e,n.colors={},n.dark=t,t(!1),$.forEach(function(e){var t=(n.isDark?w:A)[e];n[e+"Palette"]=function(r,o){var a=n.colors[e]={name:r,hues:angular.extend({},t,o)};return Object.keys(a.hues).forEach(function(e){if(!t[e])throw new Error("Invalid hue name '%1' in theme %2's %3 color %4. Available hue names: %4".replace("%1",e).replace("%2",n.name).replace("%3",r).replace("%4",Object.keys(t).join(", ")))}),Object.keys(a.hues).map(function(e){return a.hues[e]}).forEach(function(t){if(-1==y.indexOf(t))throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1",t).replace("%2",n.name).replace("%3",e).replace("%4",r).replace("%5",y.join(", ")))}),n},n[e+"Color"]=function(){var t=Array.prototype.slice.call(arguments);return console.warn("$mdThemingProviderTheme."+e+"Color() has been deprecated. Use $mdThemingProviderTheme."+e+"Palette() instead."),n[e+"Palette"].apply(n,t)}})}function g(e,t){function n(e){return void 0===e||""===e?!0:void 0!==r.THEMES[e]}function r(t,n){void 0===n&&(n=t,t=void 0),void 0===t&&(t=e),r.inherit(n,n)}return r.inherit=function(r,o){function a(e){n(e)||t.warn("Attempted to use unregistered theme '"+e+"'. Register it with $mdThemingProvider.theme().");var o=r.data("$mdThemeName");o&&r.removeClass("md-"+o+"-theme"),r.addClass("md-"+e+"-theme"),r.data("$mdThemeName",e)}var i=o.controller("mdTheme"),c=r.attr("md-theme-watch");if((b||angular.isDefined(c))&&"false"!=c){var l=e.$watch(function(){return i&&i.$mdTheme||v},a);r.on("$destroy",l)}else{var s=i&&i.$mdTheme||v;a(s)}},r.THEMES=angular.extend({},s),r.defaultTheme=function(){return v},r.registered=n,r}l={},s={},u={};var m,v="default",b=!1;return angular.extend(l,e),g.$inject=["$rootScope","$log"],m={definePalette:t,extendPalette:n,theme:a,setDefaultTheme:function(e){v=e},alwaysWatchTheme:function(e){b=e},$get:g,_LIGHT_DEFAULT_HUES:A,_DARK_DEFAULT_HUES:w,_PALETTES:l,_THEMES:s,_parseRules:r,_rgba:c}}function t(e,t,n){return{priority:100,link:{pre:function(r,o,a){var i={$setTheme:function(t){e.registered(t)||n.warn("attempted to use unregistered theme '"+t+"'"),i.$mdTheme=t}};o.data("$mdThemeController",i),i.$setTheme(t(a.mdTheme)(r)),a.$observe("mdTheme",i.$setTheme)}}}}function n(e){return e}function r(e,t,n){a(e,t),n=n.replace(/THEME_NAME/g,e.name);var r=[],o=e.colors[t],i=new RegExp(".md-"+e.name+"-theme","g"),s=new RegExp("('|\")?{{\\s*("+t+")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?","g"),u=/'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?\s*\}\}'?"?/g,f=l[o.name];return n=n.replace(u,function(t,n,r,o){return"foreground"===n?"shadow"==r?e.foregroundShadow:e.foregroundPalette[r]||e.foregroundPalette[1]:(0===r.indexOf("hue")&&(r=e.colors[n].hues[r]),c((l[e.colors[n].name][r]||"").value,o))}),angular.forEach(o.hues,function(t,o){var a=n.replace(s,function(e,n,r,o,a){return c(f[t]["color"===o?"value":"contrast"],a)});"default"!==o&&(a=a.replace(i,".md-"+e.name+"-theme.md-"+o)),r.push(a)}),r}function o(e){function t(e){var t=e.contrastDefaultColor,n=e.contrastLightColors||[],r=e.contrastStrongLightColors||[],o=e.contrastDarkColors||[];"string"==typeof n&&(n=n.split(" ")),"string"==typeof r&&(r=r.split(" ")),"string"==typeof o&&(o=o.split(" ")),delete e.contrastDefaultColor,delete e.contrastLightColors,delete e.contrastStrongLightColors,delete e.contrastDarkColors,angular.forEach(e,function(a,c){function l(){return"light"===t?o.indexOf(c)>-1?g:r.indexOf(c)>-1?v:m:n.indexOf(c)>-1?r.indexOf(c)>-1?v:m:g}if(!angular.isObject(a)){var s=i(a);if(!s)throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1",a).replace("%2",e.name).replace("%3",c));e[c]={value:s,contrast:l()}}})}var n=document.getElementsByTagName("head")[0];if(n){var o=n.firstElementChild;if(o){var a=e.has("$MD_THEME_CSS")?e.get("$MD_THEME_CSS"):"";angular.forEach(l,t);var c={},f=a.split(/\}(?!(\}|'|"|;))/).filter(function(e){return e&&e.length}).map(function(e){return e.trim()+"}"}),d=new RegExp("md-("+$.join("|")+")","g");$.forEach(function(e){c[e]=""}),f.forEach(function(e){for(var t,n=(e.match(d),0);t=$[n];n++)if(e.indexOf(".md-"+t)>-1)return c[t]+=e;for(n=0;t=$[n];n++)if(e.indexOf(t)>-1)return c[t]+=e;return c[b]+=e}),angular.forEach(s,function(e){u[e.name]||($.forEach(function(t){for(var a=r(e,t,c[t]);a.length;){var i=document.createElement("style");i.setAttribute("type","text/css"),i.appendChild(document.createTextNode(a.shift())),n.insertBefore(i,o)}}),e.colors.primary.name==e.colors.accent.name&&console.warn("$mdThemingProvider: Using the same palette for primary and accent. This violates the material design spec."),u[e.name]=!0)})}}}function a(e,t){if(!l[(e.colors[t]||{}).name])throw new Error("You supplied an invalid color palette for theme %1's %2 palette. Available palettes: %3".replace("%1",e.name).replace("%2",t).replace("%3",Object.keys(l).join(", ")))}function i(e){if(angular.isArray(e)&&3==e.length)return e;if(/^rgb/.test(e))return e.replace(/(^\s*rgba?\(|\)\s*$)/g,"").split(",").map(function(e,t){return 3==t?parseFloat(e,10):parseInt(e,10)});if("#"==e.charAt(0)&&(e=e.substring(1)),/^([a-fA-F0-9]{3}){1,2}$/g.test(e)){var t=e.length/3,n=e.substr(0,t),r=e.substr(t,t),o=e.substr(2*t);return 1===t&&(n+=n,r+=r,o+=o),[parseInt(n,16),parseInt(r,16),parseInt(o,16)]}}function c(e,t){return 4==e.length&&(e=angular.copy(e),t?e.pop():t=e.pop()),t&&("number"==typeof t||"string"==typeof t&&t.length)?"rgba("+e.join(",")+","+t+")":"rgb("+e.join(",")+")"}angular.module("material.core.theming",["material.core.theming.palette"]).directive("mdTheme",t).directive("mdThemable",n).provider("$mdTheming",e).run(o);var l,s,u,f={name:"dark",1:"rgba(0,0,0,0.87)",2:"rgba(0,0,0,0.54)",3:"rgba(0,0,0,0.26)",4:"rgba(0,0,0,0.12)"},d={name:"light",1:"rgba(255,255,255,1.0)",2:"rgba(255,255,255,0.7)",3:"rgba(255,255,255,0.3)",4:"rgba(255,255,255,0.12)"},h="1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)",p="",g=i("rgba(0,0,0,0.87)"),m=i("rgba(255,255,255,0.87"),v=i("rgb(255,255,255)"),$=["primary","accent","warn","background"],b="primary",A={accent:{"default":"A200","hue-1":"A100","hue-2":"A400","hue-3":"A700"},background:{"default":"A100","hue-1":"300","hue-2":"800","hue-3":"900"}},w={background:{"default":"800","hue-1":"300","hue-2":"600","hue-3":"900"}};$.forEach(function(e){var t={"default":"500","hue-1":"300","hue-2":"800","hue-3":"A100"};A[e]||(A[e]=t),w[e]||(w[e]=t)});var y=["50","100","200","300","400","500","600","700","800","900","A100","A200","A400","A700"];e.$inject=["$mdColorPalette"],t.$inject=["$mdTheming","$interpolate","$log"],n.$inject=["$mdTheming"],o.$inject=["$injector"]}()}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function t(t,n,i,r){function a(e,a,o,u){function l(){for(var t in n.MEDIA)r(t),r.getQuery(n.MEDIA[t]).addListener(b);return r.watchResponsiveAttributes(["md-cols","md-row-height"],o,c)}function s(){u.layoutDelegate=angular.noop,L();for(var t in n.MEDIA)r.getQuery(n.MEDIA[t]).removeListener(b)}function c(t){null==t?u.invalidateLayout():r(t)&&u.invalidateLayout()}function d(t){var n=m(),r={tileSpans:h(n),colCount:v(),rowMode:$(),rowHeight:w(),gutter:y()};if(t||!angular.equals(r,T)){var o=i(r.colCount,r.tileSpans,n).map(function(t,e){return{grid:{element:a,style:p(r.colCount,e,r.gutter,r.rowMode,r.rowHeight)},tiles:t.map(function(t,e){return{element:angular.element(n[e]),style:g(t.position,t.spans,r.colCount,r.rowCount,r.gutter,r.rowMode,r.rowHeight)}})}}).reflow().performance();e.mdOnLayout({$event:{performance:o}}),T=r}}function f(t){return M+t+x}function g(t,e,n,i,r,a,o){var u=1/n*100,l=(n-1)/n,s=A({share:u,gutterShare:l,gutter:r}),c={left:D({unit:s,offset:t.col,gutter:r}),width:C({unit:s,span:e.col,gutter:r}),paddingTop:"",marginTop:"",top:"",height:""};switch(a){case"fixed":c.top=D({unit:o,offset:t.row,gutter:r}),c.height=C({unit:o,span:e.row,gutter:r});break;case"ratio":var d=u/o,f=A({share:d,gutterShare:l,gutter:r});c.paddingTop=C({unit:f,span:e.row,gutter:r}),c.marginTop=D({unit:f,offset:t.row,gutter:r});break;case"fit":var g=(i-1)/i,d=1/i*100,f=A({share:d,gutterShare:g,gutter:r});c.top=D({unit:f,offset:t.row,gutter:r}),c.height=C({unit:f,span:e.row,gutter:r})}return c}function p(t,e,n,i,r){var a={height:"",paddingBottom:""};switch(i){case"fixed":a.height=C({unit:r,span:e,gutter:n});break;case"ratio":var o=1===t?0:(t-1)/t,u=1/t*100,l=u*(1/r),s=A({share:l,gutterShare:o,gutter:n});a.paddingBottom=C({unit:s,span:e,gutter:n});break;case"fit":}return a}function m(){return[].filter.call(a.children(),function(t){return"MD-GRID-TILE"==t.tagName})}function h(t){return[].map.call(t,function(t){var e=angular.element(t).controller("mdGridTile");return{row:parseInt(r.getResponsiveAttribute(e.$attrs,"md-rowspan"),10)||1,col:parseInt(r.getResponsiveAttribute(e.$attrs,"md-colspan"),10)||1}})}function v(){var t=parseInt(r.getResponsiveAttribute(o,"md-cols"),10);if(isNaN(t))throw"md-grid-list: md-cols attribute was not found, or contained a non-numeric value";return t}function y(){return I(r.getResponsiveAttribute(o,"md-gutter")||1)}function w(){var t=r.getResponsiveAttribute(o,"md-row-height");switch($()){case"fixed":return I(t);case"ratio":var e=t.split(":");return parseFloat(e[0])/parseFloat(e[1]);case"fit":return 0}}function $(){var t=r.getResponsiveAttribute(o,"md-row-height");return"fit"==t?"fit":-1!==t.indexOf(":")?"ratio":"fixed"}function I(t){return/\D$/.test(t)?t:t+"px"}a.attr("role","list"),u.layoutDelegate=d;var b=angular.bind(u,u.invalidateLayout),L=l();e.$on("$destroy",s);var T,M=t.startSymbol(),x=t.endSymbol(),A=t(f("share")+"% - ("+f("gutter")+" * "+f("gutterShare")+")"),D=t("calc(("+f("unit")+" + "+f("gutter")+") * "+f("offset")+")"),C=t("calc(("+f("unit")+") * "+f("span")+" + ("+f("span")+" - 1) * "+f("gutter")+")")}return{restrict:"E",controller:e,scope:{mdOnLayout:"&"},link:a}}function e(t){this.layoutInvalidated=!1,this.tilesInvalidated=!1,this.$timeout_=t,this.layoutDelegate=angular.noop}function n(t){function e(e,n){var a,o,u,l,s,c;return l=t.time(function(){o=i(e,n)}),a={layoutInfo:function(){return o},map:function(e){return s=t.time(function(){var t=a.layoutInfo();u=e(t.positioning,t.rowCount)}),a},reflow:function(e){return c=t.time(function(){var t=e||r;t(u.grid,u.tiles)}),a},performance:function(){return{tileCount:n.length,layoutTime:l,mapTime:s,reflowTime:c,totalTime:l+s+c}}}}function n(t,e){t.element.css(t.style),e.forEach(function(t){t.element.css(t.style)})}function i(t,e){function n(e,n){if(e.col>t)throw"md-grid-list: Tile at position "+n+" has a colspan ("+e.col+") that exceeds the column count ("+t+")";for(var o=0,c=0;c-o<e.col;)u>=t?i():(o=s.indexOf(0,u),-1!==o&&-1!==(c=a(o+1))?u=c+1:(o=c=0,i()));return r(o,e.col,e.row),u=o+e.col,{col:o,row:l}}function i(){u=0,l++,r(0,t,-1)}function r(t,e,n){for(var i=t;t+e>i;i++)s[i]=Math.max(s[i]+n,0)}function a(t){var e;for(e=t;e<s.length;e++)if(0!==s[e])return e;return e===s.length?e:void 0}function o(){for(var e=[],n=0;t>n;n++)e.push(0);return e}var u=0,l=0,s=o();return{positioning:e.map(function(t,e){return{spans:t,position:n(t,e)}}),rowCount:l+Math.max.apply(Math,s)}}var r=n;return e.animateWith=function(t){r=angular.isFunction(t)?t:n},e}function i(t){function e(e,n,i,r){n.attr("role","listitem");var a=t.watchResponsiveAttributes(["md-colspan","md-rowspan"],i,angular.bind(r,r.invalidateLayout));r.invalidateTiles(),e.$on("$destroy",function(){a(),r.invalidateLayout()}),angular.isDefined(e.$parent.$index)&&e.$watch(function(){return e.$parent.$index},function(t,e){t!==e&&r.invalidateTiles()})}return{restrict:"E",require:"^mdGridList",template:"<figure ng-transclude></figure>",transclude:!0,scope:{},controller:["$attrs",function(t){this.$attrs=t}],link:e}}function r(){return{template:"<figcaption ng-transclude></figcaption>",transclude:!0}}angular.module("material.components.gridList",["material.core"]).directive("mdGridList",t).directive("mdGridTile",i).directive("mdGridTileFooter",r).directive("mdGridTileHeader",r).factory("$mdGridLayout",n),t.$inject=["$interpolate","$mdConstant","$mdGridLayout","$mdMedia"],e.$inject=["$timeout"],e.prototype={invalidateTiles:function(){this.tilesInvalidated=!0,this.invalidateLayout()},invalidateLayout:function(){this.layoutInvalidated||(this.layoutInvalidated=!0,this.$timeout_(angular.bind(this,this.layout)))},layout:function(){try{this.layoutDelegate(this.tilesInvalidated)}finally{this.layoutInvalidated=!1,this.tilesInvalidated=!1}}},n.$inject=["$mdUtil"],i.$inject=["$mdMedia"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function i(i){return{restrict:"E",link:i}}angular.module("material.components.divider",["material.core"]).directive("mdDivider",i),i.$inject=["$mdTheming"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e,t){return{restrict:"E",link:function(n,o,a){t(o),e(function(){var e=o[0].querySelector("md-dialog-content");e&&e.scrollHeight>e.clientHeight&&o.addClass("md-content-overflow")})}}}function t(e){function t(e,t){return{template:['<md-dialog md-theme="{{ dialog.theme }}" aria-label="{{ dialog.ariaLabel }}">','<md-dialog-content role="document" tabIndex="0">','<h2 class="md-title">{{ dialog.title }}</h2>',"<p>{{ dialog.content }}</p>","</md-dialog-content>",'<div class="md-actions">','<md-button ng-if="dialog.$type == \'confirm\'" ng-click="dialog.abort()" class="md-primary">',"{{ dialog.cancel }}","</md-button>",'<md-button ng-click="dialog.hide()" class="md-primary">',"{{ dialog.ok }}","</md-button>","</div>","</md-dialog>"].join(""),controller:function(){this.hide=function(){e.hide(!0)},this.abort=function(){e.cancel()}},controllerAs:"dialog",bindToController:!0,theme:t.defaultTheme()}}function n(e,t,n,o,a,i,l,r,d,c,s){function m(e){var t=document.querySelector("md-dialog");t&&!t.contains(e.target)&&(e.stopImmediatePropagation(),t.focus())}function u(e,c,s){function u(){var e=c[0].querySelector(".dialog-close");if(!e){var t=c[0].querySelectorAll(".md-actions button");e=t[t.length-1]}return angular.element(e)}angular.element(t[0].body).addClass("md-dialog-is-showing"),c=n.extractElementByName(c,"md-dialog"),s.parent=angular.element(s.parent),s.popInTarget=angular.element((s.targetEvent||{}).target);var p=u();if(s.hasBackdrop){var f=s.parent[0]==t[0].body&&t[0].documentElement&&t[0].documentElement.scrollTop?angular.element(t[0].documentElement):s.parent,v=f.prop("scrollTop");s.backdrop=angular.element('<md-backdrop class="md-dialog-backdrop md-opaque">'),s.backdrop.css("top",v+"px"),a.inherit(s.backdrop,s.parent),d.enter(s.backdrop,s.parent),c.css("top",v+"px")}var k="dialog",C=p;return"alert"===s.$type&&(k="alertdialog",C=c.find("md-dialog-content")),g(c.find("md-dialog"),k,s),document.addEventListener("focus",m,!0),s.disableParentScroll&&(s.lastOverflow=s.parent.css("overflow"),s.parent.css("overflow","hidden")),b(c,s.parent,s.popInTarget&&s.popInTarget.length&&s.popInTarget).then(function(){h(c,!0),s.escapeToClose&&(s.rootElementKeyupCallback=function(e){e.keyCode===o.KEY_CODE.ESCAPE&&l(i.cancel)},r.on("keyup",s.rootElementKeyupCallback)),s.clickOutsideToClose&&(s.dialogClickOutsideCallback=function(e){e.target===c[0]&&l(i.cancel)},c.on("click",s.dialogClickOutsideCallback)),s.focusOnOpen&&C.focus()})}function p(e,n,o){return angular.element(t[0].body).removeClass("md-dialog-is-showing"),o.backdrop&&d.leave(o.backdrop),o.disableParentScroll&&(o.parent.css("overflow",o.lastOverflow),delete o.lastOverflow),o.escapeToClose&&r.off("keyup",o.rootElementKeyupCallback),o.clickOutsideToClose&&n.off("click",o.dialogClickOutsideCallback),h(n,!1),document.removeEventListener("focus",m,!0),v(n,o.parent,o.popInTarget&&o.popInTarget.length&&o.popInTarget).then(function(){n.remove(),o.popInTarget&&o.popInTarget.focus()})}function g(t,o,a){t.attr({role:o,tabIndex:"-1"});var i=t.find("md-dialog-content");0===i.length&&(i=t);var l=t.attr("id")||"dialog_"+n.nextUid();i.attr("id",l),t.attr("aria-describedby",l),a.ariaLabel?e.expect(t,"aria-label",a.ariaLabel):e.expectAsync(t,"aria-label",function(){var e=i.text().split(/\s+/);return e.length>3&&(e=e.slice(0,3).concat("...")),e.join(" ")})}function f(e,t){return-1!==t.indexOf(e.nodeName)?!0:void 0}function h(e,t){function n(e){for(;e.parentNode;){if(e===document.body)return;for(var a=e.parentNode.children,i=0;i<a.length;i++)e===a[i]||f(a[i],["SCRIPT","STYLE"])||a[i].setAttribute(o,t);n(e=e.parentNode)}}var o="aria-hidden";e=e[0],n(e)}function b(e,t,a){var i=e.find("md-dialog");return t.append(e),k(i,a),c(function(){i.addClass("transition-in").css(o.CSS.TRANSFORM,"")}),n.transitionEndPromise(i)}function v(e,t,o){var a=e.find("md-dialog");return a.addClass("transition-out").removeClass("transition-in"),k(a,o),n.transitionEndPromise(a)}function k(e,t){if(t){var n=t[0].getBoundingClientRect(),a=e[0].getBoundingClientRect(),i=Math.min(.5,n.width/a.width),l=Math.min(.5,n.height/a.height);e.css(o.CSS.TRANSFORM,"translate3d("+(-a.left+n.left+n.width/2-a.width/2)+"px,"+(-a.top+n.top+n.height/2-a.height/2)+"px,0) scale("+i+","+l+")")}}return{hasBackdrop:!0,isolateScope:!0,onShow:u,onRemove:p,clickOutsideToClose:!1,escapeToClose:!0,targetEvent:null,focusOnOpen:!0,disableParentScroll:!0,transformTemplate:function(e){return'<div class="md-dialog-container">'+e+"</div>"}}}return t.$inject=["$mdDialog","$mdTheming"],n.$inject=["$mdAria","$document","$mdUtil","$mdConstant","$mdTheming","$mdDialog","$timeout","$rootElement","$animate","$$rAF","$q"],e("$mdDialog").setDefaults({methods:["disableParentScroll","hasBackdrop","clickOutsideToClose","escapeToClose","targetEvent","parent"],options:n}).addPreset("alert",{methods:["title","content","ariaLabel","ok","theme"],options:t}).addPreset("confirm",{methods:["title","content","ariaLabel","ok","cancel","theme"],options:t})}angular.module("material.components.dialog",["material.core","material.components.backdrop"]).directive("mdDialog",e).provider("$mdDialog",t),e.$inject=["$$rAF","$mdTheming"],t.$inject=["$$interimElementProvider"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 * v0.9.0
 */
!function(){"use strict";function t(t,n,e){function r(t,n){return n.mdFontIcon?'<span class="md-font" ng-class="fontIcon"></span>':""}function i(r,i,o){function a(){var t=i.parent();return t.attr("aria-label")||t.text()?!0:t.parent().attr("aria-label")||t.parent().text()?!0:!1}n(i);var c=o.alt||r.fontIcon||r.svgIcon,u=o.$normalize(o.$attr.mdSvgIcon||o.$attr.mdSvgSrc||"");""==o.alt||a()?e.expect(i,"aria-hidden","true"):(e.expect(i,"aria-label",c),e.expect(i,"role","img")),u&&o.$observe(u,function(n){i.empty(),n&&t(n).then(function(t){i.append(t)})})}return{scope:{fontIcon:"@mdFontIcon",svgIcon:"@mdSvgIcon",svgSrc:"@mdSvgSrc"},restrict:"E",template:r,link:i}}function n(){}function e(t,n){this.url=t,this.iconSize=n||i.defaultIconSize}function r(t,n,e,r,i){function o(n){return function(e){return v[n]=d(e)?e:new f(e,t[n]),v[n].clone()}}function a(n){var r=t[n];return r?u(r.url).then(function(t){return new f(t,r)}):e.reject(n)}function c(n){function r(t){var r=n.slice(n.lastIndexOf(":")+1),i=t.querySelector("#"+r);return i?new f(i,o):e.reject(n)}var i=n.substring(0,n.lastIndexOf(":"))||"$default",o=t[i];return o?u(o.url).then(r):e.reject(n)}function u(t){return n.get(t,{cache:i}).then(function(t){return angular.element("<div>").append(t.data).find("svg")[0]})}function l(t){var n;return angular.isString(t)&&(n="icon "+t+" not found",r.warn(n)),e.reject(n||t)}function s(t){var n=angular.isString(t)?t:t.message||t.data||t.statusText;return r.warn(n),e.reject(n)}function d(t){return angular.isDefined(t.element)&&angular.isDefined(t.config)}function f(t,n){"svg"!=t.tagName&&(t=angular.element('<svg xmlns="http://www.w3.org/2000/svg">').append(t)[0]),t.getAttribute("xmlns")||t.setAttribute("xmlns","http://www.w3.org/2000/svg"),this.element=t,this.config=n,this.prepare()}function g(){var n=this.config?this.config.iconSize:t.defaultIconSize;angular.forEach({fit:"",height:"100%",width:"100%",preserveAspectRatio:"xMidYMid meet",viewBox:this.element.getAttribute("viewBox")||"0 0 "+n+" "+n},function(t,n){this.element.setAttribute(n,t)},this),angular.forEach({"pointer-events":"none",display:"block"},function(t,n){this.element.style[n]=t},this)}function p(){return this.element.cloneNode(!0)}var v={},h=/[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/i;return f.prototype={clone:p,prepare:g},function(t){return t=t||"",v[t]?e.when(v[t].clone()):h.test(t)?u(t).then(o(t)):(-1==t.indexOf(":")&&(t="$default:"+t),a(t)["catch"](c)["catch"](l)["catch"](s).then(o(t)))}}angular.module("material.components.icon",["material.core"]).directive("mdIcon",t),t.$inject=["$mdIcon","$mdTheming","$mdAria"],angular.module("material.components.icon").provider("$mdIcon",n);var i={defaultIconSize:24};n.prototype={icon:function(t,n,r){return-1==t.indexOf(":")&&(t="$default:"+t),i[t]=new e(n,r),this},iconSet:function(t,n,r){return i[t]=new e(n,r),this},defaultIconSet:function(t,n){var r="$default";return i[r]||(i[r]=new e(t,n)),i[r].iconSize=n||i.defaultIconSize,this},defaultIconSize:function(t){return i.defaultIconSize=t,this},preloadIcons:function(t){var n=this,e=[{id:"md-tabs-arrow",url:"md-tabs-arrow.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><polygon points="15.4,7.4 14,6 8,12 14,18 15.4,16.6 10.8,12 "/></g></svg>'},{id:"md-close",url:"md-close.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M19 6.41l-1.41-1.41-5.59 5.59-5.59-5.59-1.41 1.41 5.59 5.59-5.59 5.59 1.41 1.41 5.59-5.59 5.59 5.59 1.41-1.41-5.59-5.59z"/></g></svg>'},{id:"md-cancel",url:"md-cancel.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M12 2c-5.53 0-10 4.47-10 10s4.47 10 10 10 10-4.47 10-10-4.47-10-10-10zm5 13.59l-1.41 1.41-3.59-3.59-3.59 3.59-1.41-1.41 3.59-3.59-3.59-3.59 1.41-1.41 3.59 3.59 3.59-3.59 1.41 1.41-3.59 3.59 3.59 3.59z"/></g></svg>'},{id:"md-menu",url:"md-menu.svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 100 100"><path d="M 50 0 L 100 14 L 92 80 L 50 100 L 8 80 L 0 14 Z" fill="#b2b2b2"></path><path d="M 50 5 L 6 18 L 13.5 77 L 50 94 Z" fill="#E42939"></path><path d="M 50 5 L 94 18 L 86.5 77 L 50 94 Z" fill="#B72833"></path><path d="M 50 7 L 83 75 L 72 75 L 65 59 L 50 59 L 50 50 L 61 50 L 50 26 Z" fill="#b2b2b2"></path><path d="M 50 7 L 17 75 L 28 75 L 35 59 L 50 59 L 50 50 L 39 50 L 50 26 Z" fill="#fff"></path></svg>'},{id:"md-toggle-arrow",url:"md-toggle-arrow-svg",svg:'<svg version="1.1" x="0px" y="0px" viewBox="0 0 48 48"><path d="M24 16l-12 12 2.83 2.83 9.17-9.17 9.17 9.17 2.83-2.83z"/><path d="M0 0h48v48h-48z" fill="none"/></svg>'}];e.forEach(function(e){n.icon(e.id,e.url),t.put(e.url,e.svg)})},$get:["$http","$q","$log","$templateCache",function(t,n,e,o){return this.preloadIcons(o),new r(i,t,n,e,o)}]}}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 * v0.9.0
 */
!function(){"use strict";function t(t){return{restrict:"E",compile:function(e){return e[0].setAttribute("role","list"),t}}}function e(t,e,n){var i=["md-checkbox","md-switch"];return{restrict:"E",controller:"MdListController",compile:function(r,c){function a(){for(var t,e,n=["md-switch","md-checkbox"],i=0;e=n[i];++i)if((t=r.find(e)[0])&&!t.hasAttribute("aria-label")){var c=r.find("p")[0];if(!c)return;t.setAttribute("aria-label","Toggle "+c.textContent)}}function o(e){var n;if("div"==e?(n=angular.element('<div class="md-no-style md-list-item-inner">'),n.append(r.contents()),r.addClass("md-proxy-focus")):(n=angular.element('<md-button class="md-no-style"><div class="md-list-item-inner"></div></md-button>'),n[0].setAttribute("ng-click",r[0].getAttribute("ng-click")),r[0].removeAttribute("ng-click"),n.children().eq(0).append(r.contents())),r[0].setAttribute("tabindex","-1"),r.append(n),m&&m.hasAttribute("ng-click")){t.expect(m,"aria-label");var i=angular.element('<md-button class="md-secondary-container md-icon-button">');i.attr("ng-click",m.getAttribute("ng-click")),m.removeAttribute("ng-click"),m.setAttribute("tabindex","-1"),m.classList.remove("md-secondary"),i.append(m),m=i[0]}m&&(m.hasAttribute("ng-click")||c.ngClick&&l(m))&&(r.addClass("md-with-secondary"),r.append(m))}function l(t){return-1!=i.indexOf(t.nodeName.toLowerCase())}function s(t,r,c,a){function o(){var t=r.children();t.length&&!t[0].hasAttribute("ng-click")&&angular.forEach(i,function(t){angular.forEach(u.querySelectorAll(t),function(t){s.push(t)})})}function l(){(s.length||d)&&(r.addClass("md-clickable"),a.attachRipple(t,angular.element(r[0].querySelector(".md-no-style"))))}var s=[],u=r[0].firstElementChild,d=u&&u.hasAttribute("ng-click");o(),l(),r.hasClass("md-proxy-focus")&&s.length&&angular.forEach(s,function(e){e=angular.element(e),t.mouseActive=!1,e.on("mousedown",function(){t.mouseActive=!0,n(function(){t.mouseActive=!1},100)}).on("focus",function(){t.mouseActive===!1&&r.addClass("md-focused"),e.on("blur",function n(){r.removeClass("md-focused"),e.off("blur",n)})})}),d||s.length||u.addEventListener("keypress",function(t){if("INPUT"!=t.target.nodeName&&"TEXTAREA"!=t.target.nodeName){var n=t.which||t.keyCode;n==e.KEY_CODE.SPACE&&(u.click(),t.preventDefault(),t.stopPropagation())}}),r.off("click"),r.off("keypress"),s.length&&u&&r.children().eq(0).on("click",function(t){u.contains(t.target)&&angular.forEach(s,function(e){t.target===e||e.contains(t.target)||angular.element(e).triggerHandler("click")})})}var u,d,m=r[0].querySelector(".md-secondary");if(r[0].setAttribute("role","listitem"),c.ngClick)o("button");else{for(var f,g=0;f=i[g];++g)if(d=r[0].querySelector(f)){u=!0;break}u?o("div"):r.addClass("md-no-proxy")}return a(),s}}}function n(t,e,n){function i(t,e){var i={};n.attachListControlBehavior(t,e,i)}var r=this;r.attachRipple=i}angular.module("material.components.list",["material.core"]).controller("MdListController",n).directive("mdList",t).directive("mdListItem",e),t.$inject=["$mdTheming"],e.$inject=["$mdAria","$mdConstant","$timeout"],n.$inject=["$scope","$element","$mdInkRipple"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 * v0.9.0
 */
!function(){"use strict";function a(a,r){function i(a){return a.attr("aria-valuemin",0),a.attr("aria-valuemax",100),a.attr("role","progressbar"),e}function e(i,e,n){r(e);var s=e[0],c=n.mdDiameter||48,d=c/48;s.style[a.CSS.TRANSFORM]="scale("+d+")",n.$observe("value",function(a){var r=t(a);e.attr("aria-valuenow",r)})}function t(a){return Math.max(0,Math.min(a||0,100))}return{restrict:"E",template:'<div class="md-spinner-wrapper"><div class="md-inner"><div class="md-gap"></div><div class="md-left"><div class="md-half-circle"></div></div><div class="md-right"><div class="md-half-circle"></div></div></div></div>',compile:i}}angular.module("material.components.progressCircular",["material.core"]).directive("mdProgressCircular",a),a.$inject=["$mdConstant","$mdTheming"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 * v0.9.0
 */
!function(){"use strict";function e(e,n){return function(t){function o(){return e.when(t).then(function(e){return c=e,e})}var r,i="SideNav '"+t+"' is not available!",c=e.get(t);return c||e.notFoundError(t),r={isOpen:function(){return c&&c.isOpen()},isLockedOpen:function(){return c&&c.isLockedOpen()},toggle:function(){return c?c.toggle():n.reject(i)},open:function(){return c?c.open():n.reject(i)},close:function(){return c?c.close():n.reject(i)},then:function(e){var t=c?n.when(c):o();return t.then(e||angular.noop)}}}}function n(){return{restrict:"A",require:"^mdSidenav",link:function(e,n,t,o){o.focusElement(n)}}}function t(e,n,t,o,r,i,c,s,u,d){function a(a,l,f,p){function m(e,t){a.isLockedOpen=e,e===t?l.toggleClass("md-locked-open",!!e):n[e?"addClass":"removeClass"](l,"md-locked-open"),S.toggleClass("md-locked-open",!!e)}function $(e){var t=l.parent();t[e?"on":"off"]("keydown",O),S[e?"on":"off"]("click",h),e&&(C=d[0].activeElement);var o=p.focusElement();return g(e),w=u.all([e?n.enter(S,t):n.leave(S),n[e?"removeClass":"addClass"](l,"md-closed")]).then(function(){a.isOpen&&o&&o.focus()})}function g(e){var n=l.parent();e?(k=n.css("overflow"),n.css("overflow","hidden")):angular.isDefined(k)&&(n.css("overflow",k),k=void 0)}function v(n){if(a.isOpen==n)return u.when(!0);var t=u.defer();return a.isOpen=n,e(function(){w.then(function(e){a.isOpen||(C&&C.focus(),C=null),t.resolve(e)})},0,!1),t.promise}function O(e){var n=e.keyCode===i.KEY_CODE.ESCAPE;return n?h(e):u.when(!0)}function h(e){return e.preventDefault(),e.stopPropagation(),p.close()}var k,C=null,w=u.when(!0),E=t(f.mdIsLockedOpen),y=function(){return E(a.$parent,{$media:function(e){return o.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."),r(e)},$mdMedia:r})},S=c('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(a);l.on("$destroy",p.destroy),s.inherit(S,l),a.$watch(y,m),a.$watch("isOpen",$),p.$toggleOpen=v,p.focusElement(p.focusElement()||l)}return{restrict:"E",scope:{isOpen:"=?mdIsOpen"},controller:"$mdSidenavController",compile:function(e){return e.addClass("md-closed"),e.attr("tabIndex","-1"),a}}}function o(e,n,t,o,r){var i,c=this;c.isOpen=function(){return!!e.isOpen},c.isLockedOpen=function(){return!!e.isLockedOpen},c.open=function(){return c.$toggleOpen(!0)},c.close=function(){return c.$toggleOpen(!1)},c.toggle=function(){return c.$toggleOpen(!e.isOpen)},c.focusElement=function(e){return angular.isDefined(e)&&(i=e),i},c.$toggleOpen=function(){return r.when(e.isOpen)},c.destroy=o.register(c,t.mdComponentId)}angular.module("material.components.sidenav",["material.core","material.components.backdrop"]).factory("$mdSidenav",e).directive("mdSidenav",t).directive("mdSidenavFocus",n).controller("$mdSidenavController",o),e.$inject=["$mdComponentRegistry","$q"],t.$inject=["$timeout","$animate","$parse","$log","$mdMedia","$mdConstant","$compile","$mdTheming","$q","$document"],o.$inject=["$scope","$element","$attrs","$mdComponentRegistry","$q"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e,t,n,l,o,a,i){function r(o,r){var d=o.find("md-select-label").remove();if(d.length){if(!d[0].firstElementChild){var c=angular.element("<span>");c.append(d.contents()),d.append(c)}}else d=angular.element("<md-select-label><span></span></md-select-label>");if(d.append('<span class="md-select-icon" aria-hidden="true"></span>'),d.addClass("md-select-label"),d.attr("id","select_label_"+t.nextUid()),o.find("md-content").length||o.append(angular.element("<md-content>").append(o.contents())),r.mdOnOpen&&o.find("md-content").prepend(angular.element("<md-progress-circular>").attr("md-mode","indeterminate").attr("ng-hide","$$loadingAsyncDone").wrap("<div>").parent()),r.name){var s=angular.element('<select class="md-visually-hidden">');s.attr({name:"."+r.name,"ng-model":r.ngModel,"aria-hidden":"true",tabindex:"-1"});var u=o.find("md-option");angular.forEach(u,function(e){var t=angular.element("<option>"+e.innerHTML+"</option>");e.hasAttribute("ng-value")?t.attr("ng-value",e.getAttribute("ng-value")):e.hasAttribute("value")&&t.attr("value",e.getAttribute("value")),s.append(t)}),o.parent().append(s)}var p='<div class="md-select-menu-container"><md-select-menu '+(angular.isDefined(r.multiple)?"multiple":"")+">"+o.html()+"</md-select-menu></div>";return o.empty().append(d),r.tabindex=r.tabindex||"0",function(o,r,d,c){function s(){var e=r.attr("placeholder");e||(e=r.find("md-select-label").text()),l.expect(r,"aria-label",e)}function u(){$&&(y=y||$.find("md-select-menu").controller("mdSelectMenu"),C.setLabelText(y.selectedLabels()))}function f(){$=angular.element(p);var e=$.find("md-select-menu");e.data("$ngModelController",E),e.data("$mdSelectController",C),b=o.$new(),$=a($)(b),y=$.find("md-select-menu").controller("mdSelectMenu")}function m(e){var t=[32,13,38,40];if(-1!=t.indexOf(e.keyCode))e.preventDefault(),h(e);else if(e.keyCode<=90&&e.keyCode>=31){e.preventDefault();var n=y.optNodeForKeyboardSearch(e);if(!n)return;var l=angular.element(n).controller("mdOption");y.isMultiple||y.deselect(Object.keys(y.selected)[0]),y.select(l.hashKey,l.value),y.refreshViewValue(),E.$render()}}function h(){o.$evalAsync(function(){g=!0,e.show({scope:b,preserveScope:!0,skipCompile:!0,element:$,target:r[0],hasBackdrop:!0,loadingAsync:d.mdOnOpen?o.$eval(d.mdOnOpen)||!0:!1}).then(function(e){g=!1})})}var g,v,$,b,y,C=c[0],E=c[1],k=c[2],w=r.find("md-select-label"),S=0!==w.text().length;if(f(),n(r),d.name&&k){var x=r.parent()[0].querySelector('select[name=".'+d.name+'"]');k.$removeControl(angular.element(x).controller())}var M=E.$render;E.$render=function(){M(),u()},C.setLabelText=function(e){if(!S){C.setIsPlaceholder(!e),e=e||d.placeholder||"";var t=S?w:w.children().eq(0);t.text(e)}},C.setIsPlaceholder=function(e){e?w.addClass("md-placeholder"):w.removeClass("md-placeholder")},o.$$postDigest(function(){s(),u()});var O;d.$observe("ngMultiple",function(e){O&&O();var t=i(e);O=o.$watch(function(){return t(o)},function(e,t){(void 0!==e||void 0!==t)&&(e?r.attr("multiple","multiple"):r.removeAttr("multiple"),$&&(y.setMultiple(e),M=E.$render,E.$render=function(){M(),u()},y.refreshViewValue(),E.$render()))})}),d.$observe("disabled",function(e){"string"==typeof e&&(e=!0),(void 0===v||v!==e)&&(v=e,e?(r.attr({tabindex:-1,"aria-disabled":"true"}),r.off("click",h),r.off("keydown",m)):(r.attr({tabindex:d.tabindex,"aria-disabled":"false"}),r.on("click",h),r.on("keydown",m)))}),d.disabled||d.ngDisabled||(r.attr({tabindex:d.tabindex,"aria-disabled":"false"}),r.on("click",h),r.on("keydown",m)),r.attr({role:"combobox",id:"select_"+t.nextUid(),"aria-expanded":"false"}),o.$on("$destroy",function(){g?e.cancel().then(function(){$.remove()}):$.remove()})}}return{restrict:"E",require:["mdSelect","ngModel","?^form"],compile:r,controller:function(){}}}function t(e,t,n){function l(e,l,o,a){function i(){l.attr({id:"select_menu_"+t.nextUid(),role:"listbox","aria-multiselectable":c.isMultiple?"true":"false"})}function r(e){(13==e.keyCode||32==e.keyCode)&&d(e)}function d(n){var l=t.getClosest(n.target,"md-option"),o=l&&angular.element(l).data("$mdOptionController");if(l&&o){var a=c.hashGetter(o.value),i=angular.isDefined(c.selected[a]);e.$apply(function(){c.isMultiple?i?c.deselect(a):c.select(a,o.value):i||(c.deselect(Object.keys(c.selected)[0]),c.select(a,o.value)),c.refreshViewValue()})}}var c=a[0],s=a[1];n(l),l.on("click",d),l.on("keypress",r),s&&c.init(s),i()}function o(t,n,l){function o(){var e=d.ngModel.$modelValue||d.ngModel.$viewValue;if(angular.isArray(e)){var t=Object.keys(d.selected),n=e.map(d.hashGetter),l=t.filter(function(e){return-1===n.indexOf(e)});l.forEach(d.deselect),n.forEach(function(t,n){d.select(t,e[n])})}}function i(){var e=d.ngModel.$viewValue||d.ngModel.$modelValue;Object.keys(d.selected).forEach(d.deselect),d.select(d.hashGetter(e),e)}var d=this;d.isMultiple=angular.isDefined(n.multiple),d.selected={},d.options={},t.$watch(function(){return d.options},function(){d.ngModel.$render()},!0);var c;d.setMultiple=function(e){function l(e,t){return angular.isArray(e||t||[])}var a=d.ngModel;d.isMultiple=e,c&&c(),d.isMultiple?(a.$validators["md-multiple"]=l,a.$render=o,t.$watchCollection(n.ngModel,function(e){l(e)&&o(e)})):(delete a.$validators["md-multiple"],a.$render=i)};var s,u,p,f="",m=300;d.optNodeForKeyboardSearch=function(e){s&&clearTimeout(s),s=setTimeout(function(){s=void 0,f="",p=void 0,u=void 0},m),f+=String.fromCharCode(e.keyCode);var t=new RegExp("^"+f,"i");u||(u=l.find("md-option"),p=new Array(u.length),angular.forEach(u,function(e,t){p[t]=e.textContent.trim()}));for(var n=0;n<p.length;++n)if(t.test(p[n]))return u[n]},d.init=function(n){if(d.ngModel=n,n.$options&&n.$options.trackBy){var l={},o=e(n.$options.trackBy);d.hashGetter=function(e,n){return l.$value=e,o(n||t,l)}}else d.hashGetter=function(e){return angular.isObject(e)?"$$object_"+(e.$$mdSelectId||(e.$$mdSelectId=++r)):e};d.setMultiple(d.isMultiple)},d.selectedLabels=function(){var e=a(l[0].querySelectorAll("md-option[selected]"));return e.length?e.map(function(e){return e.textContent}).join(", "):""},d.select=function(e,t){var n=d.options[e];n&&n.setSelected(!0),d.selected[e]=t},d.deselect=function(e){var t=d.options[e];t&&t.setSelected(!1),delete d.selected[e]},d.addOption=function(e,t){if(angular.isDefined(d.options[e]))throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "'+t.value+'" found.');d.options[e]=t,angular.isDefined(d.selected[e])&&(d.select(e,t.value),d.refreshViewValue())},d.removeOption=function(e){delete d.options[e]},d.refreshViewValue=function(){var e,t=[];for(var n in d.selected)t.push((e=d.options[n])?e.value:d.selected[n]);d.ngModel.$setViewValue(d.isMultiple?t:t[0])}}return o.$inject=["$scope","$attrs","$element"],{restrict:"E",require:["mdSelectMenu","?ngModel"],controller:o,link:{pre:l}}}function n(e,t){function n(e,t){return e.append(angular.element('<div class="md-text">').append(e.contents())),e.attr("tabindex",t.tabindex||"0"),l}function l(n,l,o,a){function i(e,t){var l=c.hashGetter(t,n),o=c.hashGetter(e,n);d.hashKey=o,d.value=e,c.removeOption(l,d),c.addOption(o,d)}function r(){l.attr({role:"option","aria-selected":"false",id:"select_option_"+t.nextUid()})}var d=a[0],c=a[1];angular.isDefined(o.ngValue)?n.$watch(o.ngValue,i):angular.isDefined(o.value)?i(o.value):n.$watch(function(){return l.text()},i),n.$$postDigest(function(){o.$observe("selected",function(e){angular.isDefined(e)&&(e?(c.isMultiple||c.deselect(Object.keys(c.selected)[0]),c.select(d.hashKey,d.value)):c.deselect(d.hashKey),c.refreshViewValue(),c.ngModel.$render())})}),e.attachButtonBehavior(n,l),r(),n.$on("$destroy",function(){c.removeOption(d.hashKey,d)})}function o(e){this.selected=!1,this.setSelected=function(t){t&&!this.selected?e.attr({selected:"selected","aria-selected":"true"}):!t&&this.selected&&(e.removeAttr("selected"),e.attr("aria-selected","false")),this.selected=t}}return o.$inject=["$element"],{restrict:"E",require:["mdOption","^^mdSelectMenu"],controller:o,compile:n}}function l(){function e(e,t){var n=e.find("label");n.length||(n=angular.element("<label>"),e.prepend(n)),t.label&&n.text(t.label)}return{restrict:"E",compile:e}}function o(e){function t(e,t,o,r,d,c,s){function u(n,l,i){function u(){i.target.attr("aria-expanded","true")}function p(){function o(e){var t=a(m),n=t.indexOf(i.focusedNode);-1===n?n=0:"next"===e&&n<t.length-1?n++:"prev"===e&&n>0&&n--;var l=i.focusedNode=t[n];l&&l.focus()}function d(){o("next")}function c(){o("prev")}function s(){u.isMultiple||(i.restoreFocus=!0,n.$evalAsync(function(){e.hide(u.ngModel.$viewValue)}))}if(!i.isRemoved){var u=i.selectEl.controller("mdSelectMenu")||{};l.addClass("md-clickable"),i.backdrop&&i.backdrop.on("click",function(t){t.preventDefault(),t.stopPropagation(),i.restoreFocus=!1,n.$apply(e.cancel)}),i.selectEl.on("keydown",function(l){switch(l.keyCode){case t.KEY_CODE.SPACE:case t.KEY_CODE.ENTER:var o=r.getClosest(l.target,"md-option");o&&(i.selectEl.triggerHandler({type:"click",target:o}),l.preventDefault());break;case t.KEY_CODE.TAB:case t.KEY_CODE.ESCAPE:l.preventDefault(),i.restoreFocus=!0,n.$apply(e.cancel)}}),i.selectEl.on("keydown",function(e){switch(e.keyCode){case t.KEY_CODE.UP_ARROW:return c();case t.KEY_CODE.DOWN_ARROW:return d();default:if(e.keyCode>=31&&e.keyCode<=90){var n=i.selectEl.controller("mdSelectMenu").optNodeForKeyboardSearch(e);n&&n.focus()}}}),i.selectEl.on("click",s),i.selectEl.on("keydown",function(e){(32==e.keyCode||13==e.keyCode)&&s()})}}if(!i.target)throw new Error('$mdSelect.show() expected a target element in options.target but got "'+i.target+'"!');angular.extend(i,{isRemoved:!1,target:angular.element(i.target),parent:angular.element(i.parent),selectEl:l.find("md-select-menu"),contentEl:l.find("md-content"),backdrop:i.hasBackdrop&&angular.element('<md-backdrop class="md-select-backdrop md-click-catcher">')}),i.resizeFn=function(){o(function(){o(function(){f(n,l,i)})})},angular.element(s).on("resize",i.resizeFn),angular.element(s).on("orientationchange",i.resizeFn),u(),l.removeClass("md-leave");var m=i.selectEl[0].getElementsByTagName("md-option");return i.loadingAsync&&i.loadingAsync.then?i.loadingAsync.then(function(){n.$$loadingAsyncDone=!0,o(function(){o(function(){i.isRemoved||f(n,l,i)})})}):i.loadingAsync&&(n.$$loadingAsyncDone=!0),i.disableParentScroll&&!r.getClosest(i.target,"MD-DIALOG")?i.restoreScroll=r.disableScrollAround(i.target):i.disableParentScroll=!1,c(p,75,!1),i.backdrop&&(d.inherit(i.backdrop,i.parent),i.parent.append(i.backdrop)),i.parent.append(l),o(function(){o(function(){i.isRemoved||f(n,l,i)})}),r.transitionEndPromise(i.selectEl,{timeout:350})}function p(e,t,n){n.isRemoved=!0,t.addClass("md-leave").removeClass("md-clickable"),n.target.attr("aria-expanded","false"),angular.element(s).off("resize",n.resizeFn),angular.element(s).off("orientationchange",n.resizefn),n.resizeFn=void 0;var l=n.selectEl.controller("mdSelect");return l&&l.setLabelText(n.selectEl.controller("mdSelectMenu").selectedLabels()),r.transitionEndPromise(t,{timeout:350}).then(function(){t.removeClass("md-active"),n.backdrop&&n.backdrop.remove(),t[0].parentNode===n.parent[0]&&n.parent[0].removeChild(t[0]),n.disableParentScroll&&n.restoreScroll(),n.restoreFocus&&n.target.focus()})}function f(e,a,d){var c,u=a[0],p=d.target[0].firstElementChild.firstElementChild,f=d.parent[0],m=d.selectEl[0],h=d.contentEl[0],g=f.getBoundingClientRect(),v=p.getBoundingClientRect(),$=!1,b={left:g.left+i,top:i,bottom:g.height-i,right:g.width-i-(r.floatingScrollbars()?16:0)},y={top:v.top-b.top,left:v.left-b.left,right:b.right-(v.left+v.width),bottom:b.bottom-(v.top+v.height)},C=g.width-2*i,E=h.scrollHeight>h.offsetHeight,k=m.querySelector("md-option[selected]"),w=m.getElementsByTagName("md-option"),S=m.getElementsByTagName("md-optgroup");c=k?k:S.length?S[0]:w.length?w[0]:h.firstElementChild||h,h.offsetWidth>C&&(h.style["max-width"]=C+"px"),$&&(h.style["min-width"]=v.width+"px"),E&&m.classList.add("md-overflow");var x=m.getBoundingClientRect(),M=l(c);if(c){var O=s.getComputedStyle(c);M.paddingLeft=parseInt(O.paddingLeft,10)||0,M.paddingRight=parseInt(O.paddingRight,10)||0}var A=c;if("MD-OPTGROUP"===(A.tagName||"").toUpperCase()&&(A=w[0]||h.firstElementChild||h),E){var D=h.offsetHeight/2;h.scrollTop=M.top+M.height/2-D,y.top<D?h.scrollTop=Math.min(M.top,h.scrollTop+D-y.top):y.bottom<D&&(h.scrollTop=Math.max(M.top+M.height-x.height,h.scrollTop-D+y.bottom))}var R,T,V;$?(R=v.left,T=v.top+v.height,V="50% 0",T+x.height>b.bottom&&(T=v.top-x.height,V="50% 100%")):(R=v.left+M.left-M.paddingLeft,T=Math.floor(v.top+v.height/2-M.height/2-M.top+h.scrollTop),V=M.left+v.width/2+"px "+(M.top+M.height/2-h.scrollTop)+"px 0px",u.style.minWidth=v.width+M.paddingLeft+M.paddingRight+"px");var N=u.getBoundingClientRect();u.style.left=n(b.left,R,b.right-N.width)+"px",u.style.top=n(b.top,T,b.bottom-N.height)+"px",m.style[t.CSS.TRANSFORM_ORIGIN]=V,m.style[t.CSS.TRANSFORM]="scale("+Math.min(v.width/x.width,1)+","+Math.min(v.height/x.height,1)+")",o(function(){a.addClass("md-active"),m.style[t.CSS.TRANSFORM]="",A&&(d.focusedNode=A,A.focus())})}return{parent:"body",onShow:u,onRemove:p,hasBackdrop:!0,disableParentScroll:!0,themable:!0}}function n(e,t,n){return Math.max(e,Math.min(t,n))}function l(e){return e?{left:e.offsetLeft,top:e.offsetTop,width:e.offsetWidth,height:e.offsetHeight}:{left:0,top:0,width:0,height:0}}return t.$inject=["$mdSelect","$mdConstant","$$rAF","$mdUtil","$mdTheming","$timeout","$window"],e("$mdSelect").setDefaults({methods:["target"],options:t})}function a(e){for(var t=[],n=0;n<e.length;++n)t.push(e.item(n));return t}var i=8,r=0;angular.module("material.components.select",["material.core","material.components.backdrop"]).directive("mdSelect",e).directive("mdSelectMenu",t).directive("mdOption",n).directive("mdOptgroup",l).provider("$mdSelect",o),e.$inject=["$mdSelect","$mdUtil","$mdTheming","$mdAria","$interpolate","$compile","$parse"],t.$inject=["$parse","$mdUtil","$mdTheming"],n.$inject=["$mdInkRipple","$mdUtil"],o.$inject=["$$interimElementProvider"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e,t,a,n,i,r,o,s){function l(e,t){return e.attr({tabIndex:0,role:"slider"}),a.expect(e,"aria-label"),u}function u(a,l,u,d){function c(){$(),y(),p()}function m(e){B=parseFloat(e),l.attr("aria-valuemin",e),c()}function f(e){H=parseFloat(e),l.attr("aria-valuemax",e),c()}function v(e){U=parseFloat(e),p()}function g(e){l.attr("aria-disabled",!!e)}function p(){if(angular.isDefined(u.mdDiscrete)){var e=Math.floor((H-B)/U);if(!J){var a=t.getComputedStyle(I[0]);J=angular.element('<canvas style="position:absolute;">'),Q=J[0].getContext("2d"),Q.fillStyle=a.backgroundColor||"black",I.append(J)}var n=h();J[0].width=n.width,J[0].height=n.height;for(var i,r=0;e>=r;r++)i=Math.floor(n.width*(r/e)),Q.fillRect(i-1,0,2,n.height)}}function $(){X=z[0].getBoundingClientRect()}function h(){return W(),X}function b(e){if(!l[0].hasAttribute("disabled")){var t;e.keyCode===i.KEY_CODE.LEFT_ARROW?t=-U:e.keyCode===i.KEY_CODE.RIGHT_ARROW&&(t=U),t&&((e.metaKey||e.ctrlKey||e.altKey)&&(t*=4),e.preventDefault(),e.stopPropagation(),a.$evalAsync(function(){w(d.$viewValue+t)}))}}function w(e){d.$setViewValue(x(C(e)))}function y(){isNaN(d.$viewValue)&&(d.$viewValue=d.$modelValue);var e=(d.$viewValue-B)/(H-B);a.modelValue=d.$viewValue,l.attr("aria-valuenow",d.$viewValue),k(e),T.text(d.$viewValue)}function x(e){return angular.isNumber(e)?Math.max(B,Math.min(H,e)):void 0}function C(e){return angular.isNumber(e)?Math.round(e/U)*U:void 0}function k(e){G.css("width",100*e+"%"),_.css("left",100*e+"%"),l.toggleClass("md-min",0===e)}function V(e){if(!O()){l.addClass("active"),l[0].focus(),$();var t=K(F(e.pointer.x)),n=x(C(t));a.$apply(function(){w(n),k(L(n))})}}function D(e){if(!O()){l.removeClass("dragging active");var t=K(F(e.pointer.x)),n=x(C(t));a.$apply(function(){w(n),y()})}}function M(e){O()||(Z=!0,e.stopPropagation(),l.addClass("dragging"),R(e))}function S(e){Z&&(e.stopPropagation(),R(e))}function A(e){Z&&(e.stopPropagation(),Z=!1)}function R(e){ee?E(e.pointer.x):q(e.pointer.x)}function q(e){a.$evalAsync(function(){w(K(F(e)))})}function E(e){var t=K(F(e)),a=x(C(t));k(F(e)),T.text(a)}function F(e){return Math.max(0,Math.min(1,(e-X.left)/X.width))}function K(e){return B+e*(H-B)}function L(e){return(e-B)/(H-B)}r(l),d=d||{$setViewValue:function(e){this.$viewValue=e,this.$viewChangeListeners.forEach(function(e){e()})},$parsers:[],$formatters:[],$viewChangeListeners:[]};var N=u.ngDisabled&&s(u.ngDisabled),O=N?function(){return N(a.$parent)}:angular.noop,P=angular.element(l[0].querySelector(".md-thumb")),T=angular.element(l[0].querySelector(".md-thumb-text")),_=P.parent(),z=angular.element(l[0].querySelector(".md-track-container")),G=angular.element(l[0].querySelector(".md-track-fill")),I=angular.element(l[0].querySelector(".md-track-ticks")),W=n.throttle($,5e3);u.min?u.$observe("min",m):m(0),u.max?u.$observe("max",f):f(100),u.step?u.$observe("step",v):v(1);var Y=angular.noop;u.ngDisabled&&(Y=a.$parent.$watch(u.ngDisabled,g)),o.register(l,"drag"),l.on("keydown",b).on("$md.pressdown",V).on("$md.pressup",D).on("$md.dragstart",M).on("$md.drag",S).on("$md.dragend",A),setTimeout(c);var j=e.throttle(c);angular.element(t).on("resize",j),a.$on("$destroy",function(){angular.element(t).off("resize",j),Y()}),d.$render=y,d.$viewChangeListeners.push(y),d.$formatters.push(x),d.$formatters.push(C);var B,H,U,J,Q,X={};$();var Z=!1,ee=angular.isDefined(u.mdDiscrete)}return{scope:{},require:"?ngModel",template:'<div class="md-slider-wrapper">        <div class="md-track-container">          <div class="md-track"></div>          <div class="md-track md-track-fill"></div>          <div class="md-track-ticks"></div>        </div>        <div class="md-thumb-container">          <div class="md-thumb"></div>          <div class="md-focus-thumb"></div>          <div class="md-focus-ring"></div>          <div class="md-sign">            <span class="md-thumb-text"></span>          </div>          <div class="md-disabled-thumb"></div>        </div>      </div>',compile:l}}angular.module("material.components.slider",["material.core"]).directive("mdSlider",e),e.$inject=["$$rAF","$window","$mdAria","$mdUtil","$mdConstant","$mdTheming","$mdGesture","$parse"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function t(t,e,n,r,o){function l(t){function n(t,e){e.addClass("md-sticky-clone"),e.css("top",d+"px");var n={element:t,clone:e};return m.items.push(n),p.parent().prepend(n.clone),f(),function(){m.items.forEach(function(e,n){e.element[0]===t[0]&&(m.items.splice(n,1),e.clone.remove())}),f()}}function o(){m.items.forEach(l),m.items=m.items.sort(function(t,e){return t.top<e.top?-1:1});for(var t,e=p.prop("scrollTop"),n=m.items.length-1;n>=0;n--)if(e>m.items[n].top){t=m.items[n];break}i(t)}function l(t){var e=t.element[0];for(t.top=0,t.left=0;e&&e!==p[0];)t.top+=e.offsetTop,t.left+=e.offsetLeft,e=e.offsetParent;t.height=t.element.prop("offsetHeight"),t.clone.css("margin-left",t.left+"px")}function c(){var t=p.prop("scrollTop"),e=t>(c.prevScrollTop||0);c.prevScrollTop=t,0===t?i(null):e&&m.next?m.next.top-t<=0?i(m.next):m.current&&(m.next.top-t<=m.next.height?u(m.current,m.next.top-m.next.height-t):u(m.current,null)):!e&&m.current&&(t<m.current.top&&i(m.prev),m.current&&m.next&&(t>=m.next.top-m.current.height?u(m.current,m.next.top-t-m.current.height):u(m.current,null)))}function i(t){if(m.current!==t){m.current&&(u(m.current,null),a(m.current,null)),t&&a(t,"active"),m.current=t;var e=m.items.indexOf(t);m.next=m.items[e+1],m.prev=m.items[e-1],a(m.next,"next"),a(m.prev,"prev")}}function a(t,e){t&&t.state!==e&&(t.state&&(t.clone.attr("sticky-prev-state",t.state),t.element.attr("sticky-prev-state",t.state)),t.clone.attr("sticky-state",e),t.element.attr("sticky-state",e),t.state=e)}function u(t,n){t&&(null===n||void 0===n?t.translateY&&(t.translateY=null,t.clone.css(e.CSS.TRANSFORM,"")):(t.translateY=n,t.clone.css(e.CSS.TRANSFORM,"translate3d("+t.left+"px,"+n+"px,0)")))}var p=t.$element,f=r.throttle(o);s(p),p.on("$scrollstart",f),p.on("$scroll",c);var m,d=p.prop("offsetTop");return m={prev:null,current:null,next:null,items:[],add:n,refreshElements:o}}function c(e){var n,r=angular.element("<div>");t[0].body.appendChild(r[0]);for(var o=["sticky","-webkit-sticky"],l=0;l<o.length;++l)if(r.css({position:o[l],top:0,"z-index":2}),r.css("position")==o[l]){n=o[l];break}return r.remove(),n}function s(t){function e(){+o.now()-l>c?(n=!1,t.triggerHandler("$scrollend")):(t.triggerHandler("$scroll"),r(e))}var n,l,c=200;t.on("scroll touchmove",function(){n||(n=!0,r(e),t.triggerHandler("$scrollstart")),t.triggerHandler("$scroll"),l=+o.now()})}var i=c();return function(t,e,n){var r=e.controller("mdContent");if(r)if(i)e.css({position:i,top:0,"z-index":2});else{var o=r.$element.data("$$sticky");o||(o=l(r),r.$element.data("$$sticky",o));var c=o.add(e,n||e.clone());t.$on("$destroy",c)}}}angular.module("material.components.sticky",["material.core","material.components.content"]).factory("$mdSticky",t),t.$inject=["$document","$mdConstant","$compile","$$rAF","$mdUtil"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e,n,t){return{restrict:"E",replace:!0,transclude:!0,template:'<h2 class="md-subheader"><div class="md-subheader-inner"><span class="md-subheader-content"></span></div></h2>',compile:function(a,r,c){var i=a[0].outerHTML;return function(a,r,s){function u(e){return angular.element(e[0].querySelector(".md-subheader-content"))}t(r),c(a,function(e){u(r).append(e)}),r.hasClass("md-no-sticky")||c(a,function(c){var s=n(angular.element(i))(a);t(s),u(s).append(c),e(a,r,s)})}}}}angular.module("material.components.subheader",["material.core","material.components.sticky"]).directive("mdSubheader",e),e.$inject=["$mdSticky","$compile","$mdTheming"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e){function t(e){function t(t,r,c){var o=e(c[i]);r.on(n,function(e){t.$apply(function(){o(t,{$event:e})})})}return{restrict:"A",link:t}}var i="md"+e,n="$md."+e.toLowerCase();return t.$inject=["$parse"],t}angular.module("material.components.swipe",["material.core"]).directive("mdSwipeLeft",e("SwipeLeft")).directive("mdSwipeRight",e("SwipeRight"))}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(e,t,a,n,i,r,d,s){function o(e,t){var n=c.compile(e,t);return e.addClass("md-dragging"),function(e,t,o,c){function l(a){v(e)||(a.stopPropagation(),t.addClass("md-dragging"),f={width:p.prop("offsetWidth")},t.removeClass("transition"))}function m(e){if(f){e.stopPropagation(),e.srcEvent&&e.srcEvent.preventDefault();var t=e.pointer.distanceX/f.width,a=c.$viewValue?1+t:t;a=Math.max(0,Math.min(1,a)),p.css(i.CSS.TRANSFORM,"translate3d("+100*a+"%,0,0)"),f.translate=a}}function u(e){if(f){e.stopPropagation(),t.removeClass("md-dragging"),p.css(i.CSS.TRANSFORM,"");var a=c.$viewValue?f.translate<.5:f.translate>.5;a&&g(!c.$viewValue),f=null}}function g(t){e.$apply(function(){c.$setViewValue(t),c.$render()})}c=c||a.fakeNgModel();var v=r(o.ngDisabled),p=angular.element(t[0].querySelector(".md-thumb-container")),$=angular.element(t[0].querySelector(".md-container"));d(function(){t.removeClass("md-dragging")}),n(e,t,o,c),angular.isDefined(o.ngDisabled)&&e.$watch(v,function(e){t.attr("tabindex",e?-1:0)}),s.register($,"drag"),$.on("$md.dragstart",l).on("$md.drag",m).on("$md.dragend",u);var f}}var c=e[0];return{restrict:"E",priority:210,transclude:!0,template:'<div class="md-container"><div class="md-bar"></div><div class="md-thumb-container"><div class="md-thumb" md-ink-ripple md-ink-ripple-checkbox></div></div></div><div ng-transclude class="md-label"></div>',require:"?ngModel",compile:o}}angular.module("material.components.switch",["material.core","material.components.checkbox"]).directive("mdSwitch",e),e.$inject=["mdCheckboxDirective","$mdTheming","$mdUtil","$document","$mdConstant","$parse","$$rAF","$mdGesture"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function e(){function e(e,t,a,n){function s(){function e(){return a.label}function n(){var e=t.find("md-tab-label");return e.length?e.remove().html():void 0}function s(){var e=t.html();return t.empty(),e}a.label||(t.find("md-tab-label")[0]||t[0]).innerHTML;return e()||n()||s()}function d(){var e=t.find("md-tab-body"),n=e.length?e.html():a.label?t.html():null;return e.length?e.remove():a.label&&t.empty(),n}if(n){var r=t.parent()[0].getElementsByTagName("md-tab"),i=Array.prototype.indexOf.call(r,t[0]),l=n.insertTab({scope:e,parent:e.$parent,index:i,template:d(),label:s()},i);e.select=e.select||angular.noop,e.deselect=e.deselect||angular.noop,e.$watch("active",function(e){e&&n.select(l.getIndex())}),e.$watch("disabled",function(){n.refreshIndex()}),e.$on("$destroy",function(){n.removeTab(l)})}}return{require:"^?mdTabs",terminal:!0,scope:{label:"@",active:"=?mdActive",disabled:"=?ngDisabled",select:"&?mdOnSelect",deselect:"&?mdOnDeselect"},link:e}}function t(){function e(e,t,a,n){n&&n.attachRipple(e,t)}return{require:"^?mdTabs",link:e}}function a(e){return{restrict:"A",compile:function(t,a){var n=e(a.mdTabScroll,null,!0);return function(e,t){t.on("mousewheel",function(t){e.$apply(function(){n(e,{$event:t})})})}}}}function n(e,t,a,n,s,d,r,i){function l(){e.$watch("selectedIndex",I),e.$watch("$mdTabsCtrl.focusIndex",u),e.$watch("$mdTabsCtrl.offsetLeft",b),e.$watch("$mdTabsCtrl.hasContent",c),angular.element(a).on("resize",function(){e.$apply(h)}),n(k,0,!1),n(y,0,!1)}function c(e){t[e?"removeClass":"addClass"]("md-no-tab-content")}function o(){var e={};return e.wrapper=t[0].getElementsByTagName("md-tabs-wrapper")[0],e.canvas=e.wrapper.getElementsByTagName("md-tabs-canvas")[0],e.paging=e.canvas.getElementsByTagName("md-pagination-wrapper")[0],e.tabs=e.paging.getElementsByTagName("md-tab-item"),e.dummies=e.canvas.getElementsByTagName("md-dummy-tab"),e.inkBar=e.paging.getElementsByTagName("md-ink-bar")[0],e.contentsWrapper=t[0].getElementsByTagName("md-tabs-content-wrapper")[0],e.contents=e.contentsWrapper.getElementsByTagName("md-tab-content"),e}function m(t){switch(t.keyCode){case s.KEY_CODE.LEFT_ARROW:t.preventDefault(),f(-1,!0);break;case s.KEY_CODE.RIGHT_ARROW:t.preventDefault(),f(1,!0);break;case s.KEY_CODE.SPACE:case s.KEY_CODE.ENTER:t.preventDefault(),_||(e.selectedIndex=M.focusIndex)}M.lastClick=!1}function f(t,a){var n,s=a?M.focusIndex:e.selectedIndex;for(n=s+t;M.tabs[n]&&M.tabs[n].scope.disabled;n+=t);M.tabs[n]&&(a?M.focusIndex=n:e.selectedIndex=n)}function b(t){var a=B()?"":"-"+t+"px";angular.element(j.paging).css("left",a),e.$broadcast("$mdTabsPaginationChanged")}function u(e,t){e!==t&&j.tabs[e]&&(g(),p())}function p(){j.dummies[M.focusIndex].focus()}function g(){if(!B()){var e=j.tabs[M.focusIndex],t=e.offsetLeft,a=e.offsetWidth+t;M.offsetLeft=Math.max(M.offsetLeft,D(a-j.canvas.clientWidth)),M.offsetLeft=Math.min(M.offsetLeft,D(t))}}function h(){M.lastSelectedIndex=e.selectedIndex,M.offsetLeft=D(M.offsetLeft),n(k,0,!1)}function T(){K.forEach(function(e){n(e)}),K=[]}function x(t,a){var n={getIndex:function(){return M.tabs.indexOf(s)},isActive:function(){return this.getIndex()===e.selectedIndex},isLeft:function(){return this.getIndex()<e.selectedIndex},isRight:function(){return this.getIndex()>e.selectedIndex},hasFocus:function(){return!M.lastClick&&M.hasFocus&&this.getIndex()===M.focusIndex},id:r.nextUid()},s=angular.extend(n,t);return angular.isDefined(a)?M.tabs.splice(a,0,s):M.tabs.push(s),T(),v(),s}function v(){var e=!1;angular.forEach(M.tabs,function(t){t.template&&(e=!0)}),M.hasContent=e}function $(e){M.tabs.splice(e.getIndex(),1),C(),n(function(){k(),M.offsetLeft=D(M.offsetLeft)})}function C(){e.selectedIndex=P(e.selectedIndex),M.focusIndex=P(M.focusIndex)}function I(t,a){t!==a&&(e.selectedIndex=P(t),M.lastSelectedIndex=a,k(),y(),e.$broadcast("$mdTabsChanged"),M.tabs[a]&&M.tabs[a].scope.deselect(),M.tabs[t]&&M.tabs[t].scope.select())}function w(){w.watcher||(w.watcher=e.$watch(function(){n(function(){w.watcher&&t.prop("offsetParent")&&(w.watcher(),w.watcher=null,e.$apply(h))},0,!1)}))}function y(){if(!e.dynamicHeight)return t.css("height","");if(!M.tabs.length)return K.push(y);var a=j.contents[e.selectedIndex],n=a?a.offsetHeight:0,s=j.wrapper.offsetHeight,d=n+s,r=t.prop("clientHeight");r!==d&&(_=!0,i.animate(t,{height:r+"px"},{height:d+"px"}).then(function(){t.css("height",""),_=!1}))}function k(){if(!M.tabs.length)return K.push(k);if(!t.prop("offsetParent"))return w();var a=e.selectedIndex,n=j.paging.offsetWidth,s=j.tabs[a],d=s.offsetLeft,r=n-d-s.offsetWidth;L(),angular.element(j.inkBar).css({left:d+"px",right:r+"px"})}function L(){var t=e.selectedIndex,a=M.lastSelectedIndex,n=angular.element(j.inkBar);n.removeClass("md-left md-right"),angular.isNumber(a)&&(a>t?n.addClass("md-left"):t>a&&n.addClass("md-right"))}function P(e){var t,a,n=Math.max(M.tabs.length-e,e);for(t=0;n>=t;t++){if(a=M.tabs[e+t],a&&a.scope.disabled!==!0)return a.getIndex();if(a=M.tabs[e-t],a&&a.scope.disabled!==!0)return a.getIndex()}return e}function E(){switch(e.stretchTabs){case"always":return!0;case"never":return!1;default:return!W()&&a.matchMedia("(max-width: 600px)").matches}}function B(){return e.centerTabs&&!W()}function W(){if(e.noPagination)return!1;var a=t.prop("clientWidth");return angular.forEach(j.tabs,function(e){a-=e.offsetWidth}),0>a}function S(t){_||(M.focusIndex=e.selectedIndex=t),M.lastClick=!0}function N(e){W()&&(e.preventDefault(),M.offsetLeft=D(M.offsetLeft-e.wheelDelta))}function D(e){if(!j.tabs.length||!W())return 0;var t=j.tabs[j.tabs.length-1],a=t.offsetLeft+t.offsetWidth;return e=Math.max(0,e),e=Math.min(a-j.canvas.clientWidth,e)}function A(){var e,t,a=j.canvas.clientWidth,n=a+M.offsetLeft;for(e=0;e<j.tabs.length&&(t=j.tabs[e],!(t.offsetLeft+t.offsetWidth>n));e++);M.offsetLeft=D(t.offsetLeft)}function F(){var e,t;for(e=0;e<j.tabs.length&&(t=j.tabs[e],!(t.offsetLeft+t.offsetWidth>=M.offsetLeft));e++);M.offsetLeft=D(t.offsetLeft+t.offsetWidth-j.canvas.clientWidth)}function O(){return M.offsetLeft>0}function R(){var e=j.tabs[j.tabs.length-1];return e&&e.offsetLeft+e.offsetWidth>j.canvas.clientWidth+M.offsetLeft}function H(e,t){var a={colorElement:angular.element(j.inkBar)};d.attachTabBehavior(e,t,a)}var M=this,_=!1,j=o(),K=[];M.scope=e,M.parent=e.$parent,M.tabs=[],M.lastSelectedIndex=null,M.focusIndex=0,M.offsetLeft=0,M.hasContent=!1,M.hasFocus=!1,M.lastClick=!1,M.redirectFocus=p,M.attachRipple=H,M.shouldStretchTabs=E,M.shouldPaginate=W,M.shouldCenterTabs=B,M.insertTab=x,M.removeTab=$,M.select=S,M.scroll=N,M.nextPage=A,M.previousPage=F,M.keydown=m,M.canPageForward=R,M.canPageBack=O,M.refreshIndex=C,M.incrementSelectedIndex=f,M.updateInkBarStyles=k,l()}function s(e,t,a){return{scope:{noPagination:"=?mdNoPagination",dynamicHeight:"=?mdDynamicHeight",centerTabs:"=?mdCenterTabs",selectedIndex:"=?mdSelected",stretchTabs:"@?mdStretchTabs"},template:function(e,t){return t.$mdTabsTemplate=e.html(),'        <md-tabs-wrapper ng-class="{ \'md-stretch-tabs\': $mdTabsCtrl.shouldStretchTabs() }">          <md-tab-data></md-tab-data>          <md-prev-button              tabindex="-1"              role="button"              aria-label="Previous Page"              aria-disabled="{{!$mdTabsCtrl.canPageBack()}}"              ng-class="{ \'md-disabled\': !$mdTabsCtrl.canPageBack() }"              ng-if="$mdTabsCtrl.shouldPaginate()"              ng-click="$mdTabsCtrl.previousPage()">            <md-icon md-svg-icon="md-tabs-arrow"></md-icon>          </md-prev-button>          <md-next-button              tabindex="-1"              role="button"              aria-label="Next Page"              aria-disabled="{{!$mdTabsCtrl.canPageForward()}}"              ng-class="{ \'md-disabled\': !$mdTabsCtrl.canPageForward() }"              ng-if="$mdTabsCtrl.shouldPaginate()"              ng-click="$mdTabsCtrl.nextPage()">            <md-icon md-svg-icon="md-tabs-arrow"></md-icon>          </md-next-button>          <md-tabs-canvas              tabindex="0"              aria-activedescendant="tab-item-{{$mdTabsCtrl.tabs[$mdTabsCtrl.focusIndex].id}}"              ng-focus="$mdTabsCtrl.redirectFocus()"              ng-class="{                  \'md-paginated\': $mdTabsCtrl.shouldPaginate(),                  \'md-center-tabs\': $mdTabsCtrl.shouldCenterTabs()              }"              ng-keydown="$mdTabsCtrl.keydown($event)"              role="tablist">            <md-pagination-wrapper                ng-class="{ \'md-center-tabs\': $mdTabsCtrl.shouldCenterTabs() }"                md-tab-scroll="$mdTabsCtrl.scroll($event)">              <md-tab-item                  tabindex="-1"                  class="md-tab"                  style="max-width: {{ tabWidth ? tabWidth + \'px\' : \'none\' }}"                  ng-repeat="tab in $mdTabsCtrl.tabs"                  role="tab"                  aria-controls="tab-content-{{tab.id}}"                  aria-selected="{{tab.isActive()}}"                  aria-disabled="{{tab.scope.disabled || \'false\'}}"                  ng-click="$mdTabsCtrl.select(tab.getIndex())"                  ng-class="{                      \'md-active\':    tab.isActive(),                      \'md-focused\':   tab.hasFocus(),                      \'md-disabled\':  tab.scope.disabled                  }"                  ng-disabled="tab.scope.disabled"                  md-swipe-left="$mdTabsCtrl.nextPage()"                  md-swipe-right="$mdTabsCtrl.previousPage()"                  md-template="tab.label"                  md-scope="tab.parent"></md-tab-item>              <md-ink-bar ng-hide="noInkBar"></md-ink-bar>            </md-pagination-wrapper>            <div class="md-visually-hidden md-dummy-wrapper">              <md-dummy-tab                  tabindex="-1"                  id="tab-item-{{tab.id}}"                  role="tab"                  aria-controls="tab-content-{{tab.id}}"                  aria-selected="{{tab.isActive()}}"                  aria-disabled="{{tab.scope.disabled || \'false\'}}"                  ng-focus="$mdTabsCtrl.hasFocus = true"                  ng-blur="$mdTabsCtrl.hasFocus = false"                  ng-repeat="tab in $mdTabsCtrl.tabs"                  md-template="tab.label"                  md-scope="tab.parent"></md-dummy-tab>            </div>          </md-tabs-canvas>        </md-tabs-wrapper>        <md-tabs-content-wrapper ng-show="$mdTabsCtrl.hasContent">          <md-tab-content              id="tab-content-{{tab.id}}"              role="tabpanel"              aria-labelledby="tab-item-{{tab.id}}"              md-swipe-left="$mdTabsCtrl.incrementSelectedIndex(1)"              md-swipe-right="$mdTabsCtrl.incrementSelectedIndex(-1)"              ng-if="$mdTabsCtrl.hasContent"              ng-repeat="(index, tab) in $mdTabsCtrl.tabs"               md-template="tab.template"              md-scope="tab.parent"              ng-class="{                \'md-no-transition\': $mdTabsCtrl.lastSelectedIndex == null,                \'md-active\':        tab.isActive(),                \'md-left\':          tab.isLeft(),                \'md-right\':         tab.isRight(),                \'md-no-scroll\':     dynamicHeight              }"></md-tab-content>        </md-tabs-content-wrapper>      '},controller:"MdTabsController",controllerAs:"$mdTabsCtrl",link:function(n,s,d){function r(e){var t=s.find("md-tab-data");t.html(e),a(t.contents())(n.$parent)}r(d.$mdTabsTemplate),delete d.$mdTabsTemplate,t.initOptionalProperties(n,d),d.$observe("mdNoBar",function(e){n.noInkBar=angular.isDefined(e)}),n.selectedIndex=angular.isNumber(n.selectedIndex)?n.selectedIndex:0,e(s)}}}function d(e){function t(t,a,n,s){s&&(a.html(t.template),e(a.contents())(t.compileScope))}return{restrict:"A",link:t,scope:{template:"=mdTemplate",compileScope:"=mdScope"},require:"^?mdTabs"}}angular.module("material.components.tabs",["material.core","material.components.icon"]),angular.module("material.components.tabs").directive("mdTab",e),angular.module("material.components.tabs").directive("mdTabItem",t),angular.module("material.components.tabs").directive("mdTabScroll",a),a.$inject=["$parse"],angular.module("material.components.tabs").controller("MdTabsController",n),n.$inject=["$scope","$element","$window","$timeout","$mdConstant","$mdInkRipple","$mdUtil","$animate"],angular.module("material.components.tabs").directive("mdTabs",s),s.$inject=["$mdTheming","$mdUtil","$compile"],angular.module("material.components.tabs").directive("mdTemplate",d),d.$inject=["$compile"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 * v0.9.0
 */
!function(){"use strict";function t(){return{restrict:"E"}}function e(t){function e(t,e,o,i){function a(a,s,m){return s=i.extractElementByName(s,"md-toast"),n=m.content,s.addClass(m.position.split(" ").map(function(t){return"md-"+t}).join(" ")),m.parent.addClass(r(m.position)),m.onSwipe=function(e,n){s.addClass("md-"+e.type.replace("$md.","")),t(o.cancel)},s.on("$md.swipeleft $md.swiperight",m.onSwipe),e.enter(s,m.parent)}function s(t,n,o){return n.off("$md.swipeleft $md.swiperight",o.onSwipe),o.parent.removeClass(r(o.position)),e.leave(n)}function r(t){return"md-toast-open-"+(t.indexOf("top")>-1?"top":"bottom")}return{onShow:a,onRemove:s,position:"bottom left",themable:!0,hideDelay:3e3}}var n,o=t("$mdToast").setDefaults({methods:["position","hideDelay","capsule"],options:e}).addPreset("simple",{argOption:"content",methods:["content","action","highlightAction","theme","parent"],options:["$mdToast","$mdTheming",function(t,e){var o={template:['<md-toast md-theme="{{ toast.theme }}" ng-class="{\'md-capsule\': toast.capsule}">',"<span flex>{{ toast.content }}</span>",'<md-button class="md-action" ng-if="toast.action" ng-click="toast.resolve()" ng-class="{\'md-highlight\': toast.highlightAction}">',"{{ toast.action }}","</md-button>","</md-toast>"].join(""),controller:["$scope",function(e){var o=this;e.$watch(function(){return n},function(){o.content=n}),this.resolve=function(){t.hide()}}],theme:e.defaultTheme(),controllerAs:"toast",bindToController:!0};return o}]}).addMethod("updateContent",function(t){n=t});return e.$inject=["$timeout","$animate","$mdToast","$mdUtil"],o}angular.module("material.components.toast",["material.core","material.components.button"]).directive("mdToast",t).provider("$mdToast",e),e.$inject=["$$interimElementProvider"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function t(t,n,e,o,r,a){return{restrict:"E",controller:angular.noop,link:function(i,l,c){function s(){function o(n,e){l.parent()[0]===e.parent()[0]&&(u&&u.off("scroll",S),e.on("scroll",S),e.attr("scroll-shrink","true"),u=e,t(s))}function s(){d=l.prop("offsetHeight"),u.css("margin-top",-d*h+"px"),m()}function m(t){var e=t?t.target.scrollTop:p;$(),f=Math.min(d/h,Math.max(0,f+e-p)),l.css(n.CSS.TRANSFORM,"translate3d(0,"+-f*h+"px,0)"),u.css(n.CSS.TRANSFORM,"translate3d(0,"+(d-f)*h+"px,0)"),p=e,l.hasClass("md-whiteframe-z1")?f||a(function(){r.removeClass(l,"md-whiteframe-z1")}):f&&a(function(){r.addClass(l,"md-whiteframe-z1")})}var d,u,f=0,p=0,h=c.mdShrinkSpeedFactor||.5,S=t.throttle(m),$=e.debounce(s,5e3);i.$on("$mdContentLoaded",o)}o(l),angular.isDefined(c.mdScrollShrink)&&s()}}}angular.module("material.components.toolbar",["material.core","material.components.content"]).directive("mdToolbar",t),t.$inject=["$$rAF","$mdConstant","$mdUtil","$mdTheming","$animate","$timeout"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0
 */
!function(){"use strict";function t(t,e,o,n,i,a,l,r,d){function u(u,s,f){function p(){m(),v(),b(),g()}function m(){angular.isDefined(f.mdDelay)||(u.delay=h)}function g(){u.$watch("visible",function(t){t?M():C()}),u.$on("$destroy",function(){u.visible=!1,s.remove(),angular.element(e).off("resize",P)})}function v(){s.detach(),s.attr("role","tooltip"),s.attr("id",f.id||"tooltip_"+i.nextUid())}function w(){for(var t=s.parent();"none"==e.getComputedStyle(t[0])["pointer-events"];)t=t.parent();return t}function y(){for(var t=s.parent()[0];t&&t!==l[0]&&t!==document.body&&(!t.tagName||"md-content"!=t.tagName.toLowerCase());)t=t.parentNode;return t}function b(){var t=u.hasOwnProperty("autohide")?u.autohide:f.hasOwnProperty("mdAutohide");q.on("focus mouseenter touchstart",function(){$(!0)}),q.on("blur mouseleave touchend touchcancel",function(){(n[0].activeElement!==q[0]||t)&&$(!1)}),angular.element(e).on("resize",P)}function $(e){$.value=!!e,$.queued||(e?($.queued=!0,t(function(){u.visible=$.value,$.queued=!1},u.delay)):t(function(){u.visible=!1}))}function M(){k.append(s);var t=e.getComputedStyle(s[0]);return angular.isDefined(t.display)&&"none"==t.display?void s.detach():(q.attr("aria-describedby",s.attr("id")),x(),void angular.forEach([s,E,D],function(t){r.addClass(t,"md-show")}))}function C(){q.removeAttr("aria-describedby"),d.all([r.removeClass(D,"md-show"),r.removeClass(E,"md-show"),r.removeClass(s,"md-show")]).then(function(){u.visible||s.detach()})}function x(){function t(){var t="left"===N||"right"===N?2*Math.sqrt(Math.pow(n.width,2)+Math.pow(n.height/2,2)):2*Math.sqrt(Math.pow(n.width/2,2)+Math.pow(n.height,2)),e="left"===N?{left:100,top:50}:"right"===N?{left:0,top:50}:"top"===N?{left:50,top:100}:{left:50,top:0};E.css({width:t+"px",height:t+"px",left:e.left+"%",top:e.top+"%"})}function e(t){var e={left:t.left,top:t.top};return e.left=Math.min(e.left,k.prop("scrollWidth")-n.width-c),e.left=Math.max(e.left,c),e.top=Math.min(e.top,k.prop("scrollHeight")-n.height-c),e.top=Math.max(e.top,c),e}function o(t){return"left"===t?{left:a.left-n.width-c,top:a.top+a.height/2-n.height/2}:"right"===t?{left:a.left+a.width+c,top:a.top+a.height/2-n.height/2}:"top"===t?{left:a.left+a.width/2-n.width/2,top:a.top-n.height-c}:{left:a.left+a.width/2-n.width/2,top:a.top+a.height+c}}var n=i.offsetRect(s,k),a=i.offsetRect(q,k),l=o(N);N?l=e(l):l.top>s.prop("offsetParent").scrollHeight-n.height-c&&(l=e(o("top"))),s.css({top:l.top+"px",left:l.left+"px"}),t()}a(s);var q=w(),E=angular.element(s[0].getElementsByClassName("md-background")[0]),D=angular.element(s[0].getElementsByClassName("md-content")[0]),N=f.mdDirection,A=y(),k=angular.element(A||document.body),P=o.throttle(function(){u.visible&&x()});return p()}var h=300,c=8;return{restrict:"E",transclude:!0,priority:210,template:'        <div class="md-background"></div>        <div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible",delay:"=?mdDelay",autohide:"=?mdAutohide"},link:u}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",t),t.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement","$animate","$q"]}();
/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
